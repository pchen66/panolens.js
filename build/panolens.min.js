...
1;this.ImageQualityFair=2;this.ImageQualityMedium=3;this.ImageQualityHigh=4;this.ImageQualitySuperHigh=5;this.animationDuration=1E3;this.defaultInfospotSize=350;this.container=void 0;this.loaded=!1;this.linkedSpots=[];this.isInfospotVisible=!1;this.linkingImageScale=this.linkingImageURL=void 0;this.renderOrder=-1;this.active=!1;this.infospotAnimation=(new q.Tween(this)).to({},this.animationDuration/2);this.addEventListener("load",this.fadeIn.bind(this));this.addEventListener("panolens-container",
this.setContainer.bind(this));this.addEventListener("click",this.onClick.bind(this));this.setupTransitions()}function u(a){m.call(this);this.src=a;this.type="image_panorama"}function R(){m.call(this);this.type="empty_panorama"}function M(a){a=void 0===a?[]:a;m.call(this);this.images=a;this.type="cube_panorama"}function S(){for(var a=[],b=0;6>b;b++)a.push(r.WhiteTile);M.call(this,a);this.type="basic_panorama"}function z(a,b){b=void 0===b?{}:b;m.call(this);this.src=a;this.options=Object.assign({videoElement:document.createElement("video"),
...
Math.max(b.getParameter(b.MAX_TEXTURE_SIZE),this.maxW);this.maxH=Math.max(b.getParameter(b.MAX_TEXTURE_SIZE),this.maxH)}function aa(a,b){u.call(this);this.panoId=a;this.gsvLoader=null;this.loadRequested=!1;this.setupGoogleMapAPI(b);this.type="google_streetview_panorama"}function C(a,b){"image"===(void 0===a?"image":a)&&u.call(this,b);this.EPS=1E-6;this.frameId=null;this.dragging=!1;this.userMouse=new d.Vector2;this.quatA=new d.Quaternion;this.quatB=new d.Quaternion;this.quatCur=new d.Quaternion;this.quatSlerp=
new d.Quaternion;this.vectorX=new d.Vector3(1,0,0);this.vectorY=new d.Vector3(0,1,0);this.type="little_planet";this.addEventListener("window-resize",this.onWindowResize)}function ba(a){C.call(this,"image",a);this.type="image_little_planet"}function T(a){m.call(this);this.media=new Y(a);this.type="camera_panorama";this.addEventListener("enter",this.start.bind(this));this.addEventListener("leave",this.stop.bind(this));this.addEventListener("panolens-container",this.onPanolensContainer.bind(this));this.addEventListener("panolens-scene",
this.onPanolensScene.bind(this))}function N(a,b){b=void 0===b?new F:b;u.call(this,a);this.stereo=b;this.type="stereo_image_panorama"}function G(a,b,c){b=void 0===b?{}:b;c=void 0===c?new F:c;z.call(this,a,b);this.stereo=c;this.type="stereo_video_panorama"}function ca(a,b){function c(a){U=!1;O=P=0;if(!1!==f.enabled){a.preventDefault();if(a.button===f.mouseButtons.ORBIT){if(!0===f.noRotate)return;w=v.ROTATE;B.set(a.clientX,a.clientY)}else if(a.button===f.mouseButtons.ZOOM){if(!0===f.noZoom)return;w=
v.DOLLY;u.set(a.clientX,a.clientY)}else if(a.button===f.mouseButtons.PAN){if(!0===f.noPan)return;w=v.PAN;m.set(a.clientX,a.clientY)}w!==v.NONE&&(document.addEventListener("mousemove",e,!1),document.addEventListener("mouseup",g,!1),f.dispatchEvent(R));f.update()}}function e(a){if(!1!==f.enabled){a.preventDefault();var b=f.domElement===document?f.domElement.body:f.domElement;if(w===v.ROTATE){if(!0===f.noRotate)return;k.set(a.clientX,a.clientY);q.subVectors(k,B);f.rotateLeft(2*Math.PI*q.x/b.clientWidth*
f.rotateSpeed);f.rotateUp(2*Math.PI*q.y/b.clientHeight*f.rotateSpeed);B.copy(k);H&&(O=a.clientX-H.clientX,P=a.clientY-H.clientY);H=a}else if(w===v.DOLLY){if(!0===f.noZoom)return;y.set(a.clientX,a.clientY);z.subVectors(y,u);0<z.y?f.dollyIn():0>z.y&&f.dollyOut();u.copy(y)}else if(w===v.PAN){if(!0===f.noPan)return;W.set(a.clientX,a.clientY);t.subVectors(W,m);f.pan(t.x,t.y);m.copy(W)}w!==v.NONE&&f.update()}}function g(){U=!0;H=void 0;!1!==f.enabled&&(document.removeEventListener("mousemove",e,!1),document.removeEventListener("mouseup",
...
O=P=0;if(!1!==f.enabled){switch(a.touches.length){case 1:if(!0===f.noRotate)return;w=v.TOUCH_ROTATE;B.set(a.touches[0].pageX,a.touches[0].pageY);break;case 2:if(!0===f.noZoom)return;w=v.TOUCH_DOLLY;var b=a.touches[0].pageX-a.touches[1].pageX;a=a.touches[0].pageY-a.touches[1].pageY;u.set(0,Math.sqrt(b*b+a*a));break;case 3:if(!0===f.noPan)return;w=v.TOUCH_PAN;m.set(a.touches[0].pageX,a.touches[0].pageY);break;default:w=v.NONE}w!==v.NONE&&f.dispatchEvent(R)}}function x(a){if(!1!==f.enabled){a.preventDefault();
a.stopPropagation();var b=f.domElement===document?f.domElement.body:f.domElement;switch(a.touches.length){case 1:if(!0===f.noRotate)break;if(w!==v.TOUCH_ROTATE)break;k.set(a.touches[0].pageX,a.touches[0].pageY);q.subVectors(k,B);f.rotateLeft(2*Math.PI*q.x/b.clientWidth*f.rotateSpeed);f.rotateUp(2*Math.PI*q.y/b.clientHeight*f.rotateSpeed);B.copy(k);H&&(O=a.touches[0].pageX-H.pageX,P=a.touches[0].pageY-H.pageY);H={pageX:a.touches[0].pageX,pageY:a.touches[0].pageY};f.update();break;case 2:if(!0===f.noZoom)break;
...
t.subVectors(W,m);f.pan(t.x,t.y);m.copy(W);f.update();break;default:w=v.NONE}}}function Q(){U=!0;H=void 0;!1!==f.enabled&&(f.dispatchEvent(S),w=v.NONE)}this.object=a;this.domElement=void 0!==b?b:document;this.frameId=null;this.enabled=!0;this.center=this.target=new d.Vector3;this.noZoom=!1;this.zoomSpeed=1;this.minDistance=0;this.maxDistance=Infinity;this.minZoom=0;this.maxZoom=Infinity;this.noRotate=!1;this.rotateSpeed=-.15;this.noPan=!0;this.keyPanSpeed=7;this.autoRotate=!1;this.autoRotateSpeed=
2;this.minPolarAngle=0;this.maxPolarAngle=Math.PI;this.momentumDampingFactor=.9;this.momentumScalingFactor=-.005;this.momentumKeydownFactor=20;this.minFov=30;this.maxFov=120;this.minAzimuthAngle=-Infinity;this.maxAzimuthAngle=Infinity;this.noKeys=!1;this.keys={LEFT:37,UP:38,RIGHT:39,BOTTOM:40};this.mouseButtons={ORBIT:d.MOUSE.LEFT,ZOOM:d.MOUSE.MIDDLE,PAN:d.MOUSE.RIGHT};var f=this,B=new d.Vector2,k=new d.Vector2,q=new d.Vector2,m=new d.Vector2,W=new d.Vector2,t=new d.Vector2,r=new d.Vector3,A=new d.Vector3,
u=new d.Vector2,y=new d.Vector2,z=new d.Vector2,V=0,I=0,C=0,D=0,E=1,F=new d.Vector3,M=new d.Vector3,N=new d.Quaternion,O=0,P=0,H,U=!1,G,J,K,L,v={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_DOLLY:4,TOUCH_PAN:5},w=v.NONE;this.target0=this.target.clone();this.position0=this.object.position.clone();this.zoom0=this.object.zoom;var T=(new d.Quaternion).setFromUnitVectors(a.up,new d.Vector3(0,1,0)),Y=T.clone().inverse(),X={type:"change"},R={type:"start"},S={type:"end"};this.setLastQuaternion=function(a){N.copy(a);
f.object.quaternion.copy(a)};this.getLastPosition=function(){return M};this.rotateLeft=function(a){void 0===a&&(a=2*Math.PI/60/60*f.autoRotateSpeed);D-=a};this.rotateUp=function(a){void 0===a&&(a=2*Math.PI/60/60*f.autoRotateSpeed);C-=a};this.panLeft=function(a){var b=this.object.matrix.elements;r.set(b[0],b[1],b[2]);r.multiplyScalar(-a);F.add(r)};this.panUp=function(a){var b=this.object.matrix.elements;r.set(b[4],b[5],b[6]);r.multiplyScalar(a);F.add(r)};this.pan=function(a,b){var e=f.domElement===
...
A.z);I=Math.atan2(Math.sqrt(A.x*A.x+A.z*A.z),A.y);this.autoRotate&&w===v.NONE&&this.rotateLeft(2*Math.PI/60/60*f.autoRotateSpeed);this.momentum();V+=D;I+=C;V=Math.max(this.minAzimuthAngle,Math.min(this.maxAzimuthAngle,V));I=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,I));I=Math.max(1E-7,Math.min(Math.PI-1E-7,I));var e=A.length()*E;e=Math.max(this.minDistance,Math.min(this.maxDistance,e));this.target.add(F);A.x=e*Math.sin(I)*Math.sin(V);A.y=e*Math.cos(I);A.z=e*Math.sin(I)*Math.cos(V);A.applyQuaternion(Y);
b.copy(this.target).add(A);this.object.lookAt(this.target);C=D=0;E=1;F.set(0,0,0);if(1E-7<M.distanceToSquared(this.object.position)||1E-7<8*(1-N.dot(this.object.quaternion)))!0!==a&&this.dispatchEvent(X),M.copy(this.object.position),N.copy(this.object.quaternion)};this.reset=function(){w=v.NONE;this.target.copy(this.target0);this.object.position.copy(this.position0);this.object.zoom=this.zoom0;this.object.updateProjectionMatrix();this.dispatchEvent(X);this.update()};this.getPolarAngle=function(){return I};
...
this.camera=a;this.camera.rotation.reorder("YXZ");this.domElement=void 0!==b?b:document;this.enabled=!0;this.deviceOrientation={};this.alphaOffsetAngle=this.alpha=this.screenOrientation=0;var l=function(a){c.deviceOrientation=a},x=function(){c.screenOrientation=window.orientation||0},Q=function(a){a.preventDefault();a.stopPropagation();p=a.touches[0].pageX;n=a.touches[0].pageY},f=function(a){a.preventDefault();a.stopPropagation();g+=d.Math.degToRad((a.touches[0].pageX-p)/4);h+=d.Math.degToRad((n-
a.touches[0].pageY)/4);c.updateAlphaOffsetAngle(g);p=a.touches[0].pageX;n=a.touches[0].pageY};this.connect=function(){x();window.addEventListener("orientationchange",x,{passive:!0});window.addEventListener("deviceorientation",l,{passive:!0});window.addEventListener("deviceorientation",this.update.bind(this),{passive:!0});c.domElement.addEventListener("touchstart",Q,{passive:!1});c.domElement.addEventListener("touchmove",f,{passive:!1});c.enabled=!0};this.disconnect=function(){window.removeEventListener("orientationchange",
x,!1);window.removeEventListener("deviceorientation",l,!1);window.removeEventListener("deviceorientation",this.update.bind(this),!1);c.domElement.removeEventListener("touchstart",Q,!1);c.domElement.removeEventListener("touchmove",f,!1);c.enabled=!1};this.update=function(a){if(!1!==c.enabled){var b=c.deviceOrientation.alpha?d.Math.degToRad(c.deviceOrientation.alpha)+c.alphaOffsetAngle:0,g=c.deviceOrientation.beta?d.Math.degToRad(c.deviceOrientation.beta):0,f=c.deviceOrientation.gamma?d.Math.degToRad(c.deviceOrientation.gamma):
0,p=c.screenOrientation?d.Math.degToRad(c.screenOrientation):0,n=c.camera.quaternion,l=new d.Vector3(0,0,1),B=new d.Euler,x=new d.Quaternion,Q=new d.Quaternion(-Math.sqrt(.5),0,0,Math.sqrt(.5)),k=new d.Quaternion,q=new d.Quaternion;if(0==c.screenOrientation){var m=new d.Vector3(1,0,0);k.setFromAxisAngle(m,-h)}else 180==c.screenOrientation?(m=new d.Vector3(1,0,0),k.setFromAxisAngle(m,h)):90==c.screenOrientation?(m=new d.Vector3(0,1,0),k.setFromAxisAngle(m,h)):-90==c.screenOrientation&&(m=new d.Vector3(0,
1,0),k.setFromAxisAngle(m,-h));Q.multiply(k);Q.multiply(q);B.set(g,b,-f,"YXZ");n.setFromEuler(B);n.multiply(Q);n.multiply(x.setFromAxisAngle(l,-p));c.alpha=b;!0!==a&&c.dispatchEvent(e)}};this.updateAlphaOffsetAngle=function(a){this.alphaOffsetAngle=a;this.update()};this.dispose=function(){this.disconnect()};this.connect()}function ia(a){var b=new d.OrthographicCamera(-1,1,1,-1,0,1),c=new d.Scene,e=new d.StereoCamera;e.aspect=.5;var g=new d.WebGLRenderTarget(512,512,{minFilter:d.LinearFilter,magFilter:d.NearestFilter,
format:d.RGBAFormat});g.scissorTest=!0;g.texture.generateMipmaps=!1;var h=new d.Vector2(.441,.156),p=(new d.PlaneBufferGeometry(1,1,10,20)).removeAttribute("normal").toNonIndexed(),n=p.attributes.position.array,l=p.attributes.uv.array;p.attributes.position.count*=2;p.attributes.uv.count*=2;var x=new Float32Array(2*n.length);x.set(n);x.set(n,n.length);var k=new Float32Array(2*l.length);k.set(l);k.set(l,l.length);l=new d.Vector2;n=n.length/3;for(var f=0,B=x.length/3;f<B;f++){l.x=x[3*f];l.y=x[3*f+1];
var m=l.dot(l);m=1.5+(h.x+h.y*m)*m;var q=f<n?0:1;x[3*f]=l.x/m*1.5-.5+q;x[3*f+1]=l.y/m*3;k[2*f]=.5*(k[2*f]+q)}p.attributes.position.array=x;p.attributes.uv.array=k;h=new d.MeshBasicMaterial({map:g.texture});p=new d.Mesh(p,h);c.add(p);this.setEyeSeparation=function(a){e.eyeSep=a};this.setSize=function(b,e){a.setSize(b,e);var c=a.getPixelRatio();g.setSize(b*c,e*c)};this.render=function(h,f,d){var p=d instanceof N||d instanceof G;h.updateMatrixWorld();p&&this.setEyeSeparation(d.stereo.eyeSep);null===
f.parent&&f.updateMatrixWorld();e.update(f);f=g.width/2;var n=g.height;a.autoClear&&a.clear();p&&d.updateTextureToLeft();g.scissor.set(0,0,f,n);g.viewport.set(0,0,f,n);a.setRenderTarget(g);a.render(h,e.cameraL);a.clearDepth();p&&d.updateTextureToRight();g.scissor.set(f,0,f,n);g.viewport.set(f,0,f,n);a.setRenderTarget(g);a.render(h,e.cameraR);a.clearDepth();a.setRenderTarget(null);a.render(c,b)}}function ea(a){a=void 0===a?{}:a;var b=this.options=Object.assign({container:this.setupContainer(a.container),
controlBar:!0,controlButtons:["fullscreen","setting","video"],autoHideControlBar:!1,autoHideInfospot:!0,horizontalView:!1,clickTolerance:10,cameraFov:60,reverseDragging:!1,enableReticle:!1,dwellTime:1500,autoReticleSelect:!0,viewIndicator:!1,indicatorSize:30,output:null,autoRotate:!1,autoRotateSpeed:2,autoRotateActivationDuration:5E3},a);a=b.container;var c=b.cameraFov,e=b.controlBar,g=b.controlButtons,h=b.viewIndicator,p=b.indicatorSize,n=b.enableReticle,l=b.reverseDragging,k=b.output,m=b.scene,
f=b.camera;b=b.renderer;var B=a.clientWidth,r=a.clientHeight;this.container=a;this.scene=this.setupScene(m);this.sceneReticle=new d.Scene;this.camera=this.setupCamera(c,B/r,f);this.renderer=this.setupRenderer(b,a);this.reticle=this.addReticle(this.camera,this.sceneReticle);this.control=this.setupControls(this.camera,a);this.effect=this.setupEffects(this.renderer,a);this.mode=t.NORMAL;this.pressObject=this.pressEntityObject=this.infospot=this.hoverObject=this.widget=this.panorama=null;this.raycaster=
new d.Raycaster;this.raycasterPoint=new d.Vector2;this.userMouse=new d.Vector2;this.updateCallbacks=[];this.requestAnimationId=null;this.cameraFrustum=new d.Frustum;this.cameraViewProjectionMatrix=new d.Matrix4;this.outputDivElement=this.autoRotateRequestId=null;this.touchSupported="ontouchstart"in window||window.DocumentTouch&&document instanceof DocumentTouch;this.tweenLeftAnimation=new q.Tween;this.tweenUpAnimation=new q.Tween;this.outputEnabled=!1;this.viewIndicatorSize=p;this.tempEnableReticle=
n;this.handlerMouseUp=this.onMouseUp.bind(this);this.handlerMouseDown=this.onMouseDown.bind(this);this.handlerMouseMove=this.onMouseMove.bind(this);this.handlerWindowResize=this.onWindowResize.bind(this);this.handlerKeyDown=this.onKeyDown.bind(this);this.handlerKeyUp=this.onKeyUp.bind(this);this.handlerTap=this.onTap.bind(this,{clientX:B/2,clientY:r/2});e&&this.addDefaultControlBar(g);h&&this.addViewIndicator();l&&this.reverseDraggingDirection();n?this.enableReticleControl():this.registerMouseAndTouchEvents();
"overlay"===k&&this.addOutputElement();this.registerEventListeners();this.animate.call(this)}var ja="^0.105.2".replace(/[^0-9.]/g,""),E={ORBIT:0,DEVICEORIENTATION:1},t={UNKNOWN:0,NORMAL:1,CARDBOARD:2,STEREO:3},D={TAB:0,SBS:1},r={Info:"data:image/png;base64,",
...
fa={load:function(a,b,c,e){b=void 0===b?function(){}:b;c=void 0===c?function(){}:c;e=void 0===e?function(){}:e;d.Cache.enabled=!0;var g,h,p,n;for(n in r)r.hasOwnProperty(n)&&a===r[n]&&(g=n);var l=d.Cache.get(g?g:a);if(void 0!==l)return b&&setTimeout(function(){c({loaded:1,total:1});b(l)},0),l;var k=window.URL||window.webkitURL;var m=document.createElementNS("http://www.w3.org/1999/xhtml","img");d.Cache.add(g?g:a,m);var f=function(){k.revokeObjectURL(m.src);b(m)};if(0===a.indexOf("data:"))return m.addEventListener("load",
...
{constructor:F,updateUniformByFormat:function(a,b){this.format=a;var c=b.repeat.value;b=b.offset.value;var e=this.loffset,g=this.roffset;switch(a){case D.TAB:c.set(1,.5);b.set(0,.5);e.set(0,.5);g.set(0,0);break;case D.SBS:c.set(.5,1),b.set(0,0),e.set(0,0),g.set(.5,0)}},updateTextureToLeft:function(a){a.copy(this.loffset)},updateTextureToRight:function(a){a.copy(this.roffset)}});J.prototype=Object.assign(Object.create(d.Sprite.prototype),{constructor:J,setColor:function(a){this.material.color.copy(a instanceof
...
c),this.container.appendChild(a.left),this.container.appendChild(a.right))}},translateElement:function(a,b){if(this.element._width&&this.element._height&&this.getContainer()){var c=this.container;var e=this.element;var g=e._width/2;var d=e._height/2;var p=void 0!==e.verticalDelta?e.verticalDelta:40;var n=a-g;var l=b-d-p;this.mode!==t.CARDBOARD&&this.mode!==t.STEREO||!e.left||!e.right||a===c.clientWidth/2&&b===c.clientHeight/2?this.setElementStyle("transform",e,"translate("+n+"px, "+l+"px)"):(n=c.clientWidth/
...
document.msExitFullscreen(),document.mozCancelFullScreen&&document.mozCancelFullScreen(),document.webkitExitFullscreen&&document.webkitExitFullscreen(),c=!1):(g.requestFullscreen&&g.requestFullscreen(),g.msRequestFullscreen&&g.msRequestFullscreen(),g.mozRequestFullScreen&&g.mozRequestFullScreen(),g.webkitRequestFullscreen&&g.webkitRequestFullscreen(Element.ALLOW_KEYBOARD_INPUT),c=!0);this.style.backgroundImage=c?'url("'+r.FullscreenLeave+'")':'url("'+r.FullscreenEnter+'")'}});if(!document.querySelector("panolens-style-addon")){var p=
...
onContextMenu:function(){this.dragging=!1},dispose:function(){this.unregisterMouseEvents();u.prototype.dispose.call(this)}});ba.prototype=Object.assign(Object.create(C.prototype),{constructor:ba,onLoad:function(a){this.updateTexture(a);C.prototype.onLoad.call(this,a)},updateTexture:function(a){a.minFilter=a.magFilter=d.LinearFilter;this.material.uniforms.tDiffuse.value=a},dispose:function(){var a=this.material.uniforms.tDiffuse;a&&a.value&&a.value.dispose();C.prototype.dispose.call(this)}});T.prototype=
Object.assign(Object.create(m.prototype),{constructor:T,onPanolensContainer:function(a){this.media.setContainer(a.container)},onPanolensScene:function(a){this.media.setScene(a.scene)},start:function(){return this.media.start()},stop:function(){this.media.stop()}});N.prototype=Object.assign(Object.create(u.prototype),{constructor:N,onLoad:function(a){var b=a.image;this.stereo.updateUniformByFormat(4===b.width/b.height?D.SBS:D.TAB,this.material.uniforms);this.material.uniforms.tEquirect.value=a;u.prototype.onLoad.call(this,
...
g&&h.updateTextureToLeft();a.setScissor(0,0,c.width/2,c.height);a.setViewport(0,0,c.width/2,c.height);a.render(e,b.cameraL);g&&h.updateTextureToRight();a.setScissor(c.width/2,0,c.width/2,c.height);a.setViewport(c.width/2,0,c.width/2,c.height);a.render(e,b.cameraR);a.setScissorTest(!1);g&&h.updateTextureToLeft()}};ea.prototype=Object.assign(Object.create(d.EventDispatcher.prototype),{constructor:ea,setupScene:function(a){return a=void 0===a?new d.Scene:a},setupCamera:function(a,b,c){c=void 0===c?new d.PerspectiveCamera(a,
b,1,1E4):c;c.position.z=1;return c},setupRenderer:function(a,b){a=void 0===a?new d.WebGLRenderer({alpha:!0,antialias:!1}):a;var c=b.clientWidth,e=b.clientHeight;a.setPixelRatio(window.devicePixelRatio);a.setSize(c,e);a.setClearColor(0,0);a.autoClear=!1;a.domElement.classList.add("panolens-canvas");a.domElement.style.display="block";b.style.backgroundColor="#000";b.appendChild(a.domElement);return a},setupControls:function(a,b){var c=this.options,e=c.autoRotate,d=c.autoRotateSpeed,h=c.horizontalView;
c=new ca(a,b);c.id="orbit";c.minDistance=1;c.noPan=!0;c.autoRotate=e;c.autoRotateSpeed=d;h&&(c.minPolarAngle=Math.PI/2,c.maxPolarAngle=Math.PI/2);a=new da(a,b);a.id="device-orientation";a.enabled=!1;this.controls=[c,a];this.OrbitControls=c;this.DeviceOrientationControls=a;return c},setupEffects:function(a,b){var c=b.clientWidth;b=b.clientHeight;var e=new ia(a);e.setSize(c,b);a=new ma(a);a.setSize(c,b);this.CardboardEffect=e;this.StereoEffect=a;return e},setupContainer:function(a){if(a)return a._width=
a.clientWidth,a._height=a.clientHeight,a;a=document.createElement("div");a.classList.add("panolens-container");a.style.width="100%";a.style.height="100%";document.body.appendChild(a);return a},add:function(a){if(1<arguments.length){for(var b=0;b<arguments.length;b++)this.add(arguments[b]);return this}this.scene.add(a);a.addEventListener&&a.addEventListener("panolens-viewer-handler",this.eventHandler.bind(this));a instanceof m&&a.dispatchEvent&&a.dispatchEvent({type:"panolens-container",container:this.container});
a instanceof T&&a.dispatchEvent({type:"panolens-scene",scene:this.scene});a instanceof m&&(this.addPanoramaEventListener(a),this.panorama||this.setPanorama(a))},remove:function(a){a.removeEventListener&&a.removeEventListener("panolens-viewer-handler",this.eventHandler.bind(this));this.scene.remove(a)},addDefaultControlBar:function(a){if(this.widget)console.warn("Default control bar exists");else{var b=new L(this.container);b.addEventListener("panolens-viewer-handler",this.eventHandler.bind(this));
b.addControlBar();a.forEach(function(a){b.addControlButton(a)});this.widget=b}},setPanorama:function(a){var b=this.panorama;if(a instanceof m&&b!==a){this.hideInfospot();var c=function(){if(b)b.onLeave();a.removeEventListener("enter-fade-start",c)};a.addEventListener("enter-fade-start",c);(this.panorama=a).onEnter()}},eventHandler:function(a){if(a.method&&this[a.method])this[a.method](a.data)},dispatchEventToChildren:function(a){this.scene.traverse(function(b){b.dispatchEvent&&b.dispatchEvent(a)})},
activateWidgetItem:function(a,b){var c=this.widget.mainMenu,e=c.children[0];c=c.children[1];if(void 0!==a){switch(a){case 0:a=e.subMenu.children[1];break;case 1:a=e.subMenu.children[2];break;default:a=e.subMenu.children[1]}e.subMenu.setActiveItem(a);e.setSelectionTitle(a.textContent)}if(void 0!==b){switch(b){case t.CARDBOARD:a=c.subMenu.children[2];break;case t.STEREO:a=c.subMenu.children[3];break;default:a=c.subMenu.children[1]}c.subMenu.setActiveItem(a);c.setSelectionTitle(a.textContent)}},enableEffect:function(a){if(this.mode!==
a)if(a===t.NORMAL)this.disableEffect();else{this.mode=a;var b=this.camera.fov;switch(a){case t.CARDBOARD:this.effect=this.CardboardEffect;this.enableReticleControl();break;case t.STEREO:this.effect=this.StereoEffect;this.enableReticleControl();break;default:this.effect=null,this.disableReticleControl()}this.activateWidgetItem(void 0,this.mode);this.dispatchEventToChildren({type:"panolens-dual-eye-effect",mode:this.mode});this.camera.fov=b+.01;this.effect.setSize(this.container.clientWidth,this.container.clientHeight);
...
!0)},dispose:function(){function a(b){for(var c=b.children.length-1;0<=c;c--)a(b.children[c]),b.remove(b.children[c]);b instanceof m||b instanceof y?b.dispose():b.dispatchEvent&&b.dispatchEvent("dispose")}this.disableAutoRate();this.tweenLeftAnimation.stop();this.tweenUpAnimation.stop();this.unregisterEventListeners();a(this.scene);this.widget&&(this.widget.dispose(),this.widget=null);d.Cache&&d.Cache.enabled&&d.Cache.clear()},destroy:function(){this.dispose();this.render();window.cancelAnimationFrame(this.requestAnimationId)},
...
"video"===a.group?this.widget.videoElement.appendChild(b):this.widget.barElement.appendChild(b);return b},clearAllCache:function(){d.Cache.clear()}});"105"!=d.REVISION&&console.warn("three.js version is not matched. Please consider use the target revision 105");window.TWEEN=q;k.BasicPanorama=S;k.CONTROLS=E;k.CameraPanorama=T;k.CubePanorama=M;k.CubeTextureLoader=ha;k.DataImage=r;k.EmptyPanorama=R;k.GoogleStreetviewPanorama=aa;k.ImageLittlePlanet=ba;k.ImageLoader=fa;k.ImagePanorama=u;k.Infospot=y;k.LittlePlanet=
C;k.MODES=t;k.Media=Y;k.Panorama=m;k.REVISION="11";k.Reticle=J;k.STEREOFORMAT=D;k.Stereo=F;k.StereoImagePanorama=N;k.StereoVideoPanorama=G;k.THREE_REVISION="105";k.THREE_VERSION=ja;k.TextureLoader=K;k.VERSION="0.11.0";k.VideoPanorama=z;k.Viewer=ea;k.Widget=L;Object.defineProperty(k,"__esModule",{value:!0})});
