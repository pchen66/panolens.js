...
h,!1),f.dispatchEvent(Y),C=A.NONE)}function n(a){if(!1!==f.enabled&&!0!==f.noZoom&&C===A.NONE){a.preventDefault();a.stopPropagation();var b=0;void 0!==a.wheelDelta?b=a.wheelDelta:void 0!==a.detail&&(b=-a.detail);a=0<b;b=0>b;if(this.revertZoomScrollDirection?!a:a)f.object.fov=f.object.fov<f.maxFov?f.object.fov+1:f.maxFov,f.object.updateProjectionMatrix();else if(this.revertZoomScrollDirection?!b:b)f.object.fov=f.object.fov>f.minFov?f.object.fov-1:f.minFov,f.object.updateProjectionMatrix();f.update();
f.dispatchEvent(U);f.dispatchEvent(S);f.dispatchEvent(Y)}}function E(a){switch(a.keyCode){case f.keys.UP:N=!1;break;case f.keys.BOTTOM:Q=!1;break;case f.keys.LEFT:W=!1;break;case f.keys.RIGHT:X=!1}}function v(a){if(!1!==f.enabled&&!0!==f.noKeys&&!0!==f.noRotate){switch(a.keyCode){case f.keys.UP:N=!0;break;case f.keys.BOTTOM:Q=!0;break;case f.keys.LEFT:W=!0;break;case f.keys.RIGHT:X=!0}if(N||Q||W||X)R=!0,N&&(P=-f.rotateSpeed*f.momentumKeydownFactor),Q&&(P=f.rotateSpeed*f.momentumKeydownFactor),W&&
(O=-f.rotateSpeed*f.momentumKeydownFactor),X&&(O=f.rotateSpeed*f.momentumKeydownFactor)}}function m(a){R=!1;O=P=0;if(!1!==f.enabled){switch(a.touches.length){case 1:if(!0===f.noRotate)return;C=A.TOUCH_ROTATE;J.set(a.touches[0].pageX,a.touches[0].pageY);break;case 2:if(!0===f.noZoom)return;C=A.TOUCH_DOLLY;var b=a.touches[0].pageX-a.touches[1].pageX;a=a.touches[0].pageY-a.touches[1].pageY;x.set(0,Math.sqrt(b*b+a*a));break;case 3:if(!0===f.noPan)return;C=A.TOUCH_PAN;t.set(a.touches[0].pageX,a.touches[0].pageY);
break;default:C=A.NONE}C!==A.NONE&&f.dispatchEvent(S)}}function g(a){if(!1!==f.enabled){a.preventDefault();a.stopPropagation();var b=f.domElement===document?f.domElement.body:f.domElement;switch(a.touches.length){case 1:if(!0===f.noRotate)break;if(C!==A.TOUCH_ROTATE)break;l.set(a.touches[0].pageX,a.touches[0].pageY);p.subVectors(l,J);f.rotateLeft(2*Math.PI*p.x/b.clientWidth*f.rotateSpeed);f.rotateUp(2*Math.PI*p.y/b.clientHeight*f.rotateSpeed);J.copy(l);K&&(O=a.touches[0].pageX-K.pageX,P=a.touches[0].pageY-
K.pageY);K={pageX:a.touches[0].pageX,pageY:a.touches[0].pageY};f.update();break;case 2:if(!0===f.noZoom)break;if(C!==A.TOUCH_DOLLY)break;b=a.touches[0].pageX-a.touches[1].pageX;a=a.touches[0].pageY-a.touches[1].pageY;y.set(0,Math.sqrt(b*b+a*a));z.subVectors(y,x);0>z.y?(f.object.fov=f.object.fov<f.maxFov?f.object.fov+1:f.maxFov,f.object.updateProjectionMatrix()):0<z.y&&(f.object.fov=f.object.fov>f.minFov?f.object.fov-1:f.minFov,f.object.updateProjectionMatrix());x.copy(y);f.update();f.dispatchEvent(U);
break;case 3:if(!0===f.noPan)break;if(C!==A.TOUCH_PAN)break;r.set(a.touches[0].pageX,a.touches[0].pageY);u.subVectors(r,t);f.pan(u.x,u.y);t.copy(r);f.update();break;default:C=A.NONE}}}function k(){R=!0;K=void 0;!1!==f.enabled&&(f.dispatchEvent(Y),C=A.NONE)}this.object=a;this.domElement=void 0!==b?b:document;this.frameId=null;this.enabled=!0;this.center=this.target=new e.Vector3;this.noZoom=!1;this.zoomSpeed=1;this.revertZoomScrollDirection=!1;this.minDistance=0;this.maxDistance=Infinity;this.minZoom=
...
var f=this,J=new e.Vector2,l=new e.Vector2,p=new e.Vector2,t=new e.Vector2,r=new e.Vector2,u=new e.Vector2,w=new e.Vector3,q=new e.Vector3,x=new e.Vector2,y=new e.Vector2,z=new e.Vector2,B=0,L=0,D=0,F=0,G=1,H=new e.Vector3,I=new e.Vector3,M=new e.Quaternion,O=0,P=0,K,R=!1,N,Q,W,X,A={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_DOLLY:4,TOUCH_PAN:5},C=A.NONE;this.target0=this.target.clone();this.position0=this.object.position.clone();this.zoom0=this.object.zoom;var T=(new e.Quaternion).setFromUnitVectors(a.up,
new e.Vector3(0,1,0)),V=T.clone().invert(),U={type:"change"},S={type:"start"},Y={type:"end"};this.setLastQuaternion=function(a){M.copy(a);f.object.quaternion.copy(a)};this.getLastPosition=function(){return I};this.rotateLeft=function(a){void 0===a&&(a=2*Math.PI/60/60*f.autoRotateSpeed);F-=a};this.rotateUp=function(a){void 0===a&&(a=2*Math.PI/60/60*f.autoRotateSpeed);D-=a};this.panLeft=function(a){var b=this.object.matrix.elements;w.set(b[0],b[1],b[2]);w.multiplyScalar(-a);H.add(w)};this.panUp=function(a){var b=
this.object.matrix.elements;w.set(b[4],b[5],b[6]);w.multiplyScalar(a);H.add(w)};this.pan=function(a,b){var d=f.domElement===document?f.domElement.body:f.domElement;if(f.object instanceof e.PerspectiveCamera){var c=f.object.position.clone().sub(f.target).length();c*=Math.tan(f.object.fov/2*Math.PI/180);f.panLeft(2*a*c/d.clientHeight);f.panUp(2*b*c/d.clientHeight)}else f.object instanceof e.OrthographicCamera?(f.panLeft(a*(f.object.right-f.object.left)/d.clientWidth),f.panUp(b*(f.object.top-f.object.bottom)/
d.clientHeight)):console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled.")};this.momentum=function(){R&&(1E-4>Math.abs(O)&&1E-4>Math.abs(P)?R=!1:(P*=this.momentumDampingFactor,O*=this.momentumDampingFactor,F-=this.momentumScalingFactor*O,D-=this.momentumScalingFactor*P))};this.dollyIn=function(a){void 0===a&&(a=Math.pow(.95,f.zoomSpeed));f.object instanceof e.PerspectiveCamera?G/=a:f.object instanceof e.OrthographicCamera?(f.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,
this.object.zoom*a)),f.object.updateProjectionMatrix(),f.dispatchEvent(U)):console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.")};this.dollyOut=function(a){void 0===a&&(a=Math.pow(.95,f.zoomSpeed));f.object instanceof e.PerspectiveCamera?G*=a:f.object instanceof e.OrthographicCamera?(f.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/a)),f.object.updateProjectionMatrix(),f.dispatchEvent(U)):console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.")};
this.update=function(a){var b=this.object.position;q.copy(b).sub(this.target);q.applyQuaternion(T);B=Math.atan2(q.x,q.z);L=Math.atan2(Math.sqrt(q.x*q.x+q.z*q.z),q.y);this.autoRotate&&C===A.NONE&&this.rotateLeft(2*Math.PI/60/60*f.autoRotateSpeed);this.momentum();B+=F;L+=D;B=Math.max(this.minAzimuthAngle,Math.min(this.maxAzimuthAngle,B));L=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,L));L=Math.max(1E-7,Math.min(Math.PI-1E-7,L));var d=q.length()*G;d=Math.max(this.minDistance,Math.min(this.maxDistance,
d));this.target.add(H);q.x=d*Math.sin(L)*Math.sin(B);q.y=d*Math.cos(L);q.z=d*Math.sin(L)*Math.cos(B);q.applyQuaternion(V);b.copy(this.target).add(q);this.object.lookAt(this.target);D=F=0;G=1;H.set(0,0,0);if(1E-7<I.distanceToSquared(this.object.position)||1E-7<8*(1-M.dot(this.object.quaternion)))!0!==a&&this.dispatchEvent(U),I.copy(this.object.position),M.copy(this.object.quaternion)};this.reset=function(){C=A.NONE;this.target.copy(this.target0);this.object.position.copy(this.position0);this.object.zoom=
this.zoom0;this.object.updateProjectionMatrix();this.dispatchEvent(U);this.update()};this.getPolarAngle=function(){return L};this.getAzimuthalAngle=function(){return B};this.dispose=function(){this.domElement.removeEventListener("mousedown",c);this.domElement.removeEventListener("mousewheel",n);this.domElement.removeEventListener("DOMMouseScroll",n);this.domElement.removeEventListener("touchstart",m);this.domElement.removeEventListener("touchend",k);this.domElement.removeEventListener("touchmove",
g);window.removeEventListener("keyup",E);window.removeEventListener("keydown",v)};this.domElement.addEventListener("mousedown",c,{passive:!1});this.domElement.addEventListener("mousewheel",n,{passive:!1});this.domElement.addEventListener("DOMMouseScroll",n,{passive:!1});this.domElement.addEventListener("touchstart",m,{passive:!1});this.domElement.addEventListener("touchend",k,{passive:!1});this.domElement.addEventListener("touchmove",g,{passive:!1});window.addEventListener("keyup",E,{passive:!1});
window.addEventListener("keydown",v,{passive:!1});this.update()}function V(a,b){var c=this,d={type:"change"},h=0,n=0,E=0,v=0;this.camera=a;this.camera.rotation.reorder("YXZ");this.domElement=void 0!==b?b:document;this.enabled=!0;this.deviceOrientation={};this.alphaOffsetAngle=this.alpha=this.screenOrientation=0;var m=function(a){c.deviceOrientation=a},g=function(){c.screenOrientation=window.orientation||0},k=function(a){a.preventDefault();a.stopPropagation();E=a.touches[0].pageX;v=a.touches[0].pageY},
f=function(a){a.preventDefault();a.stopPropagation();h+=e.Math.degToRad((a.touches[0].pageX-E)/4);n+=e.Math.degToRad((v-a.touches[0].pageY)/4);c.updateAlphaOffsetAngle(h);E=a.touches[0].pageX;v=a.touches[0].pageY};this.connect=function(){g();window.addEventListener("orientationchange",g,{passive:!0});window.addEventListener("deviceorientation",m,{passive:!0});window.addEventListener("deviceorientation",this.update.bind(this),{passive:!0});c.domElement.addEventListener("touchstart",k,{passive:!1});
...
mouseEvent:a}),this.pressObject=void 0)}if(e&&e instanceof p){if(this.infospot=e,"click"===b)return!0}else this.infospot&&this.hideInfospot();this.options.autoRotate&&"mousemove"!==this.userMouse.type&&(clearTimeout(this.autoRotateRequestId),this.control===this.OrbitControls&&(this.OrbitControls.autoRotate=!1,this.autoRotateRequestId=window.setTimeout(this.enableAutoRate.bind(this),this.options.autoRotateActivationDuration)))}};g.prototype.getConvertedIntersect=function(a){for(var b,c=0;c<a.length;c++)if(0<=
a[c].distance&&a[c].object&&!a[c].object.passThrough&&(!a[c].object.entity||!a[c].object.entity.passThrough)){b=a[c].object.entity&&!a[c].object.entity.passThrough?a[c].object.entity:a[c].object;break}return b};g.prototype.hideInfospot=function(){this.infospot&&(this.infospot.onHoverEnd(),this.infospot=void 0)};g.prototype.toggleControlBar=function(){var a=this.widget;a&&a.dispatchEvent({type:"control-bar-toggle"})};g.prototype.onKeyDown=function(a){this.options.output&&"none"!==this.options.output&&
"Control"===a.key&&(this.OUTPUT_INFOSPOT=!0)};g.prototype.onKeyUp=function(){this.OUTPUT_INFOSPOT=!1};g.prototype.update=function(){t.update();this.updateCallbacks.forEach(function(a){a()});this.control.update();this.scene.traverse(function(a){if(a instanceof p&&a.element&&(this.hoverObject===a||"none"!==a.element.style.display||a.element.left&&"none"!==a.element.left.style.display||a.element.right&&"none"!==a.element.right.style.display))if(this.checkSpriteInViewport(a)){var b=this.getScreenVector(a.getWorldPosition(new e.Vector3));
a.translateElement(b.x,b.y)}else a.onDismiss()}.bind(this))};g.prototype.render=function(){this.mode===q.CARDBOARD||this.mode===q.STEREO?(this.renderer.clear(),this.effect.render(this.scene,this.camera),this.effect.render(this.sceneReticle,this.camera)):(this.renderer.clear(),this.renderer.render(this.scene,this.camera),this.renderer.clearDepth(),this.renderer.render(this.sceneReticle,this.camera))};g.prototype.animate=function(){this.requestAnimationId=window.requestAnimationFrame(this.animate.bind(this));
this.onChange()};g.prototype.onChange=function(){this.update();this.render()};g.prototype.registerMouseAndTouchEvents=function(){var a={passive:!1};this.container.addEventListener("mousedown",this.HANDLER_MOUSE_DOWN,a);this.container.addEventListener("mousemove",this.HANDLER_MOUSE_MOVE,a);this.container.addEventListener("mouseup",this.HANDLER_MOUSE_UP,a);this.container.addEventListener("touchstart",this.HANDLER_MOUSE_DOWN,a);this.container.addEventListener("touchend",this.HANDLER_MOUSE_UP,a)};g.prototype.unregisterMouseAndTouchEvents=
function(){this.container.removeEventListener("mousedown",this.HANDLER_MOUSE_DOWN,!1);this.container.removeEventListener("mousemove",this.HANDLER_MOUSE_MOVE,!1);this.container.removeEventListener("mouseup",this.HANDLER_MOUSE_UP,!1);this.container.removeEventListener("touchstart",this.HANDLER_MOUSE_DOWN,!1);this.container.removeEventListener("touchend",this.HANDLER_MOUSE_UP,!1)};g.prototype.registerReticleEvent=function(){this.addUpdateCallback(this.HANDLER_TAP)};g.prototype.unregisterReticleEvent=
function(){this.removeUpdateCallback(this.HANDLER_TAP)};g.prototype.updateReticleEvent=function(){var a=this.container.clientWidth/2+this.container.offsetLeft,b=this.container.clientHeight/2;this.removeUpdateCallback(this.HANDLER_TAP);this.HANDLER_TAP=this.onTap.bind(this,{clientX:a,clientY:b});this.addUpdateCallback(this.HANDLER_TAP)};g.prototype.registerEventListeners=function(){window.addEventListener("resize",this.HANDLER_WINDOW_RESIZE,!0);window.addEventListener("keydown",this.HANDLER_KEY_DOWN,
!0);window.addEventListener("keyup",this.HANDLER_KEY_UP,!0)};g.prototype.unregisterEventListeners=function(){window.removeEventListener("resize",this.HANDLER_WINDOW_RESIZE,!0);window.removeEventListener("keydown",this.HANDLER_KEY_DOWN,!0);window.removeEventListener("keyup",this.HANDLER_KEY_UP,!0)};g.prototype.dispose=function(){function a(b){for(var c=b.children.length-1;0<=c;c--)a(b.children[c]),b.remove(b.children[c]);b instanceof l||b instanceof p?b.dispose():b.dispatchEvent&&b.dispatchEvent("dispose")}
this.tweenLeftAnimation.stop();this.tweenUpAnimation.stop();this.unregisterEventListeners();a(this.scene);this.widget&&(this.widget.dispose(),this.widget=null);e.Cache&&e.Cache.enabled&&e.Cache.clear()};g.prototype.destroy=function(){this.dispose();this.render();window.cancelAnimationFrame(this.requestAnimationId)};g.prototype.onPanoramaDispose=function(a){a instanceof w&&this.hideVideoWidget();a===this.panorama&&(this.panorama=null)};g.prototype.loadAsyncRequest=function(a,b){b=void 0===b?function(){}:
b;var c=new window.XMLHttpRequest;c.onloadend=function(a){b(a)};c.open("GET",a,!0);c.send(null)};g.prototype.addViewIndicator=function(){var a=this;this.loadAsyncRequest(y.ViewIndicator,function(b){if(0!==b.loaded){b=b.target.responseXML.documentElement;b.style.width=a.viewIndicatorSize+"px";b.style.height=a.viewIndicatorSize+"px";b.style.position="absolute";b.style.top="10px";b.style.left="10px";b.style.opacity="0.5";b.style.cursor="pointer";b.id="panolens-view-indicator-container";a.container.appendChild(b);
var c=b.querySelector("#indicator");a.addUpdateCallback(function(){a.radius=.225*a.viewIndicatorSize;a.currentPanoAngle=a.camera.rotation.y-e.Math.degToRad(90);a.fovAngle=e.Math.degToRad(a.camera.fov);a.leftAngle=-a.currentPanoAngle-a.fovAngle/2;a.rightAngle=-a.currentPanoAngle+a.fovAngle/2;a.leftX=a.radius*Math.cos(a.leftAngle);a.leftY=a.radius*Math.sin(a.leftAngle);a.rightX=a.radius*Math.cos(a.rightAngle);a.rightY=a.radius*Math.sin(a.rightAngle);a.indicatorD="M "+a.leftX+" "+a.leftY+" A "+a.radius+
" "+a.radius+" 0 0 1 "+a.rightX+" "+a.rightY;a.leftX&&a.leftY&&a.rightX&&a.rightY&&a.radius&&c.setAttribute("d",a.indicatorD)});b.addEventListener("mouseenter",function(){this.style.opacity="1"});b.addEventListener("mouseleave",function(){this.style.opacity="0.5"})}})};g.prototype.appendControlItem=function(a){var b=this.widget.createCustomItem(a);"video"===a.group?this.widget.videoElement.appendChild(b):this.widget.barElement.appendChild(b);return b};g.prototype.clearAllCache=function(){e.Cache.clear()};
"136"!=e.REVISION&&console.warn("three.js version is not matched. Please consider use the target revision 136");window.TWEEN=t;k.BasicPanorama=ba;k.CONTROLS=M;k.CONTROL_BUTTONS={FULLSCREEN:"fullscreen",SETTING:"setting",VIDEO:"video"};k.CameraPanorama=H;k.CubePanorama=G;k.CubeTextureLoader=Z;k.DataImage=y;k.EmptyPanorama=aa;k.GoogleStreetviewPanorama=F;k.ImageLittlePlanet=N;k.ImageLoader=S;k.ImagePanorama=z;k.Infospot=p;k.LittlePlanet=r;k.MODES=q;k.Media=D;k.OUTPUTS={NONE:"none",CONSOLE:"console",
OVERLAY:"overlay"};k.Panorama=l;k.REVISION="0";k.Reticle=B;k.THREE_REVISION="136";k.THREE_VERSION=u;k.TextureLoader=Q;k.VERSION="0.0.7";k.VideoPanorama=w;k.Viewer=g;k.Widget=x;Object.defineProperty(k,"__esModule",{value:!0})});
