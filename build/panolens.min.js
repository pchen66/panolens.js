...
h,!1),f.dispatchEvent(Y),C=A.NONE)}function n(a){if(!1!==f.enabled&&!0!==f.noZoom&&C===A.NONE){a.preventDefault();a.stopPropagation();var b=0;void 0!==a.wheelDelta?b=a.wheelDelta:void 0!==a.detail&&(b=-a.detail);a=0<b;b=0>b;(f.revertZoomScrollDirection?!a:a)?(f.object.fov=f.object.fov<f.maxFov?f.object.fov+1:f.maxFov,f.object.updateProjectionMatrix()):b&&(f.object.fov=f.object.fov>f.minFov?f.object.fov-1:f.minFov,f.object.updateProjectionMatrix());f.update();f.dispatchEvent(U);f.dispatchEvent(S);
f.dispatchEvent(Y)}}function E(a){switch(a.keyCode){case f.keys.UP:N=!1;break;case f.keys.BOTTOM:Q=!1;break;case f.keys.LEFT:W=!1;break;case f.keys.RIGHT:X=!1}}function v(a){if(!1!==f.enabled&&!0!==f.noKeys&&!0!==f.noRotate){switch(a.keyCode){case f.keys.UP:N=!0;break;case f.keys.BOTTOM:Q=!0;break;case f.keys.LEFT:W=!0;break;case f.keys.RIGHT:X=!0}if(N||Q||W||X)R=!0,N&&(P=-f.rotateSpeed*f.momentumKeydownFactor),Q&&(P=f.rotateSpeed*f.momentumKeydownFactor),W&&(O=-f.rotateSpeed*f.momentumKeydownFactor),
...
OVERLAY:"overlay"};k.Panorama=l;k.REVISION="0";k.Reticle=B;k.THREE_REVISION="136";k.THREE_VERSION=u;k.TextureLoader=Q;k.VERSION="0.0.8";k.VideoPanorama=w;k.Viewer=g;k.Widget=x;Object.defineProperty(k,"__esModule",{value:!0})});
