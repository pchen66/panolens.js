(function(k,e){"object"===typeof exports&&"undefined"!==typeof module?e(exports,require("three")):"function"===typeof define&&define.amd?define(["exports","three"],e):(k=k||self,e(k.PANOLENS={},k.THREE))})(this,function(k,e){function S(a){this.constraints=Object.assign({video:{width:{ideal:1920},height:{ideal:1080},facingMode:{exact:"environment"}},audio:!1},a);this.element=this.scene=this.container=null;this.devices=[];this.stream=null;this.ratioScalar=1;this.videoDeviceIndex=0}function M(a,b,c){a=
void 0===a?16777215:a;b=void 0===b?!0:b;c=void 0===c?1500:c;this.dpr=window.devicePixelRatio;var d=this.createCanvas(),m=d.canvas;d=d.context;var g=new e.SpriteMaterial({color:a,map:this.createCanvasTexture(m)});e.Sprite.call(this,g);this.canvasWidth=m.width;this.canvasHeight=m.height;this.context=d;this.color=a instanceof e.Color?a:new e.Color(a);this.autoSelect=b;this.dwellTime=c;this.rippleDuration=500;this.position.z=-10;this.center.set(.5,.5);this.scale.set(.5,.5,1);this.callback=this.timerId=
...
this.addEventListener("panolens-container",this.setContainer.bind(this));this.addEventListener("click",this.onClick.bind(this));this.setupTransitions()}function x(a,b,c){b=b||new e.SphereBufferGeometry(5E3,60,40);c=c||new e.MeshBasicMaterial({opacity:0,transparent:!0});q.call(this,b,c);this.src=a;this.radius=5E3}function W(){var a=new e.BufferGeometry,b=new e.MeshBasicMaterial({color:0,opacity:0,transparent:!0});a.addAttribute("position",new e.BufferAttribute(new Float32Array,1));q.call(this,a,b)}
function E(a){a=void 0===a?[]:a;var b=Object.assign({},e.ShaderLib.cube),c=new e.BoxBufferGeometry(1E4,1E4,1E4);b=new e.ShaderMaterial({fragmentShader:b.fragmentShader,vertexShader:b.vertexShader,uniforms:b.uniforms,side:e.BackSide,transparent:!0});q.call(this,c,b);this.images=a;this.edgeLength=1E4;this.material.uniforms.opacity.value=0}function O(){for(var a=[],b=0;6>b;b++)a.push(u.WhiteTile);E.call(this,a)}function A(a,b){b=void 0===b?{}:b;var c=new e.SphereBufferGeometry(5E3,60,40),d=new e.MeshBasicMaterial({opacity:0,
...
this.setVideoCurrentTime.bind(this))}function P(a){this._parameters=a=void 0===a?{}:a;this._panoId=this._zoom=null;this._panoClient=new google.maps.StreetViewService;this._total=this._count=0;this._canvas=[];this._ctx=[];this._hc=this._wc=0;this.result=null;this.rotation=0;this.copyright="";this.onPanoramaLoad=this.onSizeChange=null;this.levelsW=[1,2,4,7,13,26];this.levelsH=[1,1,2,4,7,13];this.widths=[416,832,1664,3328,6656,13312];this.heights=[416,416,832,1664,3328,6656];this.maxH=this.maxW=6656;
var b;try{var c=document.createElement("canvas");(b=c.getContext("experimental-webgl"))||(b=c.getContext("webgl"))}catch(d){}this.maxW=Math.max(b.getParameter(b.MAX_TEXTURE_SIZE),this.maxW);this.maxH=Math.max(b.getParameter(b.MAX_TEXTURE_SIZE),this.maxH)}function Z(a,b){x.call(this);this.panoId=a;this.gsvLoader=null;this.loadRequested=!1;this.setupGoogleMapAPI(b)}function B(a,b,c,d){c=void 0===c?1E4:c;d=void 0===d?.5:d;"image"===(void 0===a?"image":a)&&x.call(this,b,this.createGeometry(c,d),this.createMaterial(c));
this.size=c;this.ratio=d;this.EPS=1E-6;this.frameId=null;this.dragging=!1;this.userMouse=new e.Vector2;this.quatA=new e.Quaternion;this.quatB=new e.Quaternion;this.quatCur=new e.Quaternion;this.quatSlerp=new e.Quaternion;this.vectorX=new e.Vector3(1,0,0);this.vectorY=new e.Vector3(0,1,0);this.addEventListener("window-resize",this.onWindowResize)}function aa(a,b,c){B.call(this,"image",a,b,c)}function J(a){var b=new e.SphereBufferGeometry(5E3,60,40),c=new e.MeshBasicMaterial({visible:!1});q.call(this,
b,c);this.media=new S(a);this.radius=5E3;this.addEventListener("enter",this.start.bind(this));this.addEventListener("leave",this.stop.bind(this));this.addEventListener("panolens-container",this.onPanolensContainer.bind(this));this.addEventListener("panolens-scene",this.onPanolensScene.bind(this))}function ba(a,b){function c(a){Q=!1;K=L=0;if(!1!==f.enabled){a.preventDefault();if(a.button===f.mouseButtons.ORBIT){if(!0===f.noRotate)return;w=v.ROTATE;F.set(a.clientX,a.clientY)}else if(a.button===f.mouseButtons.ZOOM){if(!0===
f.noZoom)return;w=v.DOLLY;x.set(a.clientX,a.clientY)}else if(a.button===f.mouseButtons.PAN){if(!0===f.noPan)return;w=v.PAN;q.set(a.clientX,a.clientY)}w!==v.NONE&&(document.addEventListener("mousemove",d,!1),document.addEventListener("mouseup",m,!1),f.dispatchEvent(O));f.update()}}function d(a){if(!1!==f.enabled){a.preventDefault();var d=f.domElement===document?f.domElement.body:f.domElement;if(w===v.ROTATE){if(!0===f.noRotate)return;k.set(a.clientX,a.clientY);r.subVectors(k,F);f.rotateLeft(2*Math.PI*
r.x/d.clientWidth*f.rotateSpeed);f.rotateUp(2*Math.PI*r.y/d.clientHeight*f.rotateSpeed);F.copy(k);G&&(K=a.clientX-G.clientX,L=a.clientY-G.clientY);G=a}else if(w===v.DOLLY){if(!0===f.noZoom)return;y.set(a.clientX,a.clientY);T.subVectors(y,x);0<T.y?f.dollyIn():0>T.y&&f.dollyOut();x.copy(y)}else if(w===v.PAN){if(!0===f.noPan)return;U.set(a.clientX,a.clientY);t.subVectors(U,q);f.pan(t.x,t.y);q.copy(U)}w!==v.NONE&&f.update()}}function m(){Q=!0;G=void 0;!1!==f.enabled&&(document.removeEventListener("mousemove",
d,!1),document.removeEventListener("mouseup",m,!1),f.dispatchEvent(P),w=v.NONE)}function g(a){if(!1!==f.enabled&&!0!==f.noZoom&&w===v.NONE){a.preventDefault();a.stopPropagation();var d=0;void 0!==a.wheelDelta?d=a.wheelDelta:void 0!==a.detail&&(d=-a.detail);0<d?(f.object.fov=f.object.fov<f.maxFov?f.object.fov+1:f.maxFov,f.object.updateProjectionMatrix()):0>d&&(f.object.fov=f.object.fov>f.minFov?f.object.fov-1:f.minFov,f.object.updateProjectionMatrix());f.update();f.dispatchEvent(V);f.dispatchEvent(O);
f.dispatchEvent(P)}}function l(a){switch(a.keyCode){case f.keys.UP:I=!1;break;case f.keys.BOTTOM:J=!1;break;case f.keys.LEFT:X=!1;break;case f.keys.RIGHT:Y=!1}}function p(a){if(!1!==f.enabled&&!0!==f.noKeys&&!0!==f.noRotate){switch(a.keyCode){case f.keys.UP:I=!0;break;case f.keys.BOTTOM:J=!0;break;case f.keys.LEFT:X=!0;break;case f.keys.RIGHT:Y=!0}if(I||J||X||Y)Q=!0,I&&(L=-f.rotateSpeed*f.momentumKeydownFactor),J&&(L=f.rotateSpeed*f.momentumKeydownFactor),X&&(K=-f.rotateSpeed*f.momentumKeydownFactor),
Y&&(K=f.rotateSpeed*f.momentumKeydownFactor)}}function h(a){Q=!1;K=L=0;if(!1!==f.enabled){switch(a.touches.length){case 1:if(!0===f.noRotate)return;w=v.TOUCH_ROTATE;F.set(a.touches[0].pageX,a.touches[0].pageY);break;case 2:if(!0===f.noZoom)return;w=v.TOUCH_DOLLY;var d=a.touches[0].pageX-a.touches[1].pageX;a=a.touches[0].pageY-a.touches[1].pageY;x.set(0,Math.sqrt(d*d+a*a));break;case 3:if(!0===f.noPan)return;w=v.TOUCH_PAN;q.set(a.touches[0].pageX,a.touches[0].pageY);break;default:w=v.NONE}w!==v.NONE&&
f.dispatchEvent(O)}}function n(a){if(!1!==f.enabled){a.preventDefault();a.stopPropagation();var d=f.domElement===document?f.domElement.body:f.domElement;switch(a.touches.length){case 1:if(!0===f.noRotate)break;if(w!==v.TOUCH_ROTATE)break;k.set(a.touches[0].pageX,a.touches[0].pageY);r.subVectors(k,F);f.rotateLeft(2*Math.PI*r.x/d.clientWidth*f.rotateSpeed);f.rotateUp(2*Math.PI*r.y/d.clientHeight*f.rotateSpeed);F.copy(k);G&&(K=a.touches[0].pageX-G.pageX,L=a.touches[0].pageY-G.pageY);G={pageX:a.touches[0].pageX,
pageY:a.touches[0].pageY};f.update();break;case 2:if(!0===f.noZoom)break;if(w!==v.TOUCH_DOLLY)break;d=a.touches[0].pageX-a.touches[1].pageX;a=a.touches[0].pageY-a.touches[1].pageY;y.set(0,Math.sqrt(d*d+a*a));T.subVectors(y,x);0>T.y?(f.object.fov=f.object.fov<f.maxFov?f.object.fov+1:f.maxFov,f.object.updateProjectionMatrix()):0<T.y&&(f.object.fov=f.object.fov>f.minFov?f.object.fov-1:f.minFov,f.object.updateProjectionMatrix());x.copy(y);f.update();f.dispatchEvent(V);break;case 3:if(!0===f.noPan)break;
if(w!==v.TOUCH_PAN)break;U.set(a.touches[0].pageX,a.touches[0].pageY);t.subVectors(U,q);f.pan(t.x,t.y);q.copy(U);f.update();break;default:w=v.NONE}}}function C(){Q=!0;G=void 0;!1!==f.enabled&&(f.dispatchEvent(P),w=v.NONE)}this.object=a;this.domElement=void 0!==b?b:document;this.frameId=null;this.enabled=!0;this.center=this.target=new e.Vector3;this.noZoom=!1;this.zoomSpeed=1;this.minDistance=0;this.maxDistance=Infinity;this.minZoom=0;this.maxZoom=Infinity;this.noRotate=!1;this.rotateSpeed=-.15;this.noPan=
!0;this.keyPanSpeed=7;this.autoRotate=!1;this.autoRotateSpeed=2;this.minPolarAngle=0;this.maxPolarAngle=Math.PI;this.momentumDampingFactor=.9;this.momentumScalingFactor=-.005;this.momentumKeydownFactor=20;this.minFov=30;this.maxFov=120;this.minAzimuthAngle=-Infinity;this.maxAzimuthAngle=Infinity;this.noKeys=!1;this.keys={LEFT:37,UP:38,RIGHT:39,BOTTOM:40};this.mouseButtons={ORBIT:e.MOUSE.LEFT,ZOOM:e.MOUSE.MIDDLE,PAN:e.MOUSE.RIGHT};var f=this,F=new e.Vector2,k=new e.Vector2,r=new e.Vector2,q=new e.Vector2,
U=new e.Vector2,t=new e.Vector2,u=new e.Vector3,z=new e.Vector3,x=new e.Vector2,y=new e.Vector2,T=new e.Vector2,R=0,H=0,A=0,B=0,D=1,E=new e.Vector3,M=new e.Vector3,N=new e.Quaternion,K=0,L=0,G,Q=!1,I,J,X,Y,v={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_DOLLY:4,TOUCH_PAN:5},w=v.NONE;this.target0=this.target.clone();this.position0=this.object.position.clone();this.zoom0=this.object.zoom;var S=(new e.Quaternion).setFromUnitVectors(a.up,new e.Vector3(0,1,0)),W=S.clone().inverse(),V={type:"change"},
O={type:"start"},P={type:"end"};this.setLastQuaternion=function(a){N.copy(a);f.object.quaternion.copy(a)};this.getLastPosition=function(){return M};this.rotateLeft=function(a){void 0===a&&(a=2*Math.PI/60/60*f.autoRotateSpeed);B-=a};this.rotateUp=function(a){void 0===a&&(a=2*Math.PI/60/60*f.autoRotateSpeed);A-=a};this.panLeft=function(a){var d=this.object.matrix.elements;u.set(d[0],d[1],d[2]);u.multiplyScalar(-a);E.add(u)};this.panUp=function(a){var d=this.object.matrix.elements;u.set(d[4],d[5],d[6]);
u.multiplyScalar(a);E.add(u)};this.pan=function(a,d){var b=f.domElement===document?f.domElement.body:f.domElement;if(f.object instanceof e.PerspectiveCamera){var c=f.object.position.clone().sub(f.target).length();c*=Math.tan(f.object.fov/2*Math.PI/180);f.panLeft(2*a*c/b.clientHeight);f.panUp(2*d*c/b.clientHeight)}else f.object instanceof e.OrthographicCamera?(f.panLeft(a*(f.object.right-f.object.left)/b.clientWidth),f.panUp(d*(f.object.top-f.object.bottom)/b.clientHeight)):console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled.")};
this.momentum=function(){Q&&(1E-4>Math.abs(K)&&1E-4>Math.abs(L)?Q=!1:(L*=this.momentumDampingFactor,K*=this.momentumDampingFactor,B-=this.momentumScalingFactor*K,A-=this.momentumScalingFactor*L))};this.dollyIn=function(a){void 0===a&&(a=Math.pow(.95,f.zoomSpeed));f.object instanceof e.PerspectiveCamera?D/=a:f.object instanceof e.OrthographicCamera?(f.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom*a)),f.object.updateProjectionMatrix(),f.dispatchEvent(V)):console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.")};
this.dollyOut=function(a){void 0===a&&(a=Math.pow(.95,f.zoomSpeed));f.object instanceof e.PerspectiveCamera?D*=a:f.object instanceof e.OrthographicCamera?(f.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/a)),f.object.updateProjectionMatrix(),f.dispatchEvent(V)):console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.")};this.update=function(a){var d=this.object.position;z.copy(d).sub(this.target);z.applyQuaternion(S);R=Math.atan2(z.x,
z.z);H=Math.atan2(Math.sqrt(z.x*z.x+z.z*z.z),z.y);this.autoRotate&&w===v.NONE&&this.rotateLeft(2*Math.PI/60/60*f.autoRotateSpeed);this.momentum();R+=B;H+=A;R=Math.max(this.minAzimuthAngle,Math.min(this.maxAzimuthAngle,R));H=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,H));H=Math.max(1E-7,Math.min(Math.PI-1E-7,H));var b=z.length()*D;b=Math.max(this.minDistance,Math.min(this.maxDistance,b));this.target.add(E);z.x=b*Math.sin(H)*Math.sin(R);z.y=b*Math.cos(H);z.z=b*Math.sin(H)*Math.cos(R);z.applyQuaternion(W);
d.copy(this.target).add(z);this.object.lookAt(this.target);A=B=0;D=1;E.set(0,0,0);if(1E-7<M.distanceToSquared(this.object.position)||1E-7<8*(1-N.dot(this.object.quaternion)))!0!==a&&this.dispatchEvent(V),M.copy(this.object.position),N.copy(this.object.quaternion)};this.reset=function(){w=v.NONE;this.target.copy(this.target0);this.object.position.copy(this.position0);this.object.zoom=this.zoom0;this.object.updateProjectionMatrix();this.dispatchEvent(V);this.update()};this.getPolarAngle=function(){return H};
this.getAzimuthalAngle=function(){return R};this.dispose=function(){this.domElement.removeEventListener("mousedown",c);this.domElement.removeEventListener("mousewheel",g);this.domElement.removeEventListener("DOMMouseScroll",g);this.domElement.removeEventListener("touchstart",h);this.domElement.removeEventListener("touchend",C);this.domElement.removeEventListener("touchmove",n);window.removeEventListener("keyup",l);window.removeEventListener("keydown",p)};this.domElement.addEventListener("mousedown",
c,{passive:!1});this.domElement.addEventListener("mousewheel",g,{passive:!1});this.domElement.addEventListener("DOMMouseScroll",g,{passive:!1});this.domElement.addEventListener("touchstart",h,{passive:!1});this.domElement.addEventListener("touchend",C,{passive:!1});this.domElement.addEventListener("touchmove",n,{passive:!1});window.addEventListener("keyup",l,{passive:!1});window.addEventListener("keydown",p,{passive:!1});this.update()}function ca(a,b){var c=this,d={type:"change"},m=0,g=0,l=0,p=0;
this.camera=a;this.camera.rotation.reorder("YXZ");this.domElement=void 0!==b?b:document;this.enabled=!0;this.deviceOrientation={};this.alphaOffsetAngle=this.alpha=this.screenOrientation=0;var h=function(a){c.deviceOrientation=a},n=function(){c.screenOrientation=window.orientation||0},C=function(a){a.preventDefault();a.stopPropagation();l=a.touches[0].pageX;p=a.touches[0].pageY},f=function(a){a.preventDefault();a.stopPropagation();m+=e.Math.degToRad((a.touches[0].pageX-l)/4);g+=e.Math.degToRad((p-
a.touches[0].pageY)/4);c.updateAlphaOffsetAngle(m);l=a.touches[0].pageX;p=a.touches[0].pageY};this.connect=function(){n();window.addEventListener("orientationchange",n,{passive:!0});window.addEventListener("deviceorientation",h,{passive:!0});window.addEventListener("deviceorientation",this.update.bind(this),{passive:!0});c.domElement.addEventListener("touchstart",C,{passive:!1});c.domElement.addEventListener("touchmove",f,{passive:!1});c.enabled=!0};this.disconnect=function(){window.removeEventListener("orientationchange",
n,!1);window.removeEventListener("deviceorientation",h,!1);window.removeEventListener("deviceorientation",this.update.bind(this),!1);c.domElement.removeEventListener("touchstart",C,!1);c.domElement.removeEventListener("touchmove",f,!1);c.enabled=!1};this.update=function(a){if(!1!==c.enabled){var b=c.deviceOrientation.alpha?e.Math.degToRad(c.deviceOrientation.alpha)+c.alphaOffsetAngle:0,m=c.deviceOrientation.beta?e.Math.degToRad(c.deviceOrientation.beta):0,f=c.deviceOrientation.gamma?e.Math.degToRad(c.deviceOrientation.gamma):
0,l=c.screenOrientation?e.Math.degToRad(c.screenOrientation):0,p=c.camera.quaternion,h=new e.Vector3(0,0,1),n=new e.Euler,F=new e.Quaternion,C=new e.Quaternion(-Math.sqrt(.5),0,0,Math.sqrt(.5)),k=new e.Quaternion,r=new e.Quaternion;if(0==c.screenOrientation){var q=new e.Vector3(1,0,0);k.setFromAxisAngle(q,-g)}else 180==c.screenOrientation?(q=new e.Vector3(1,0,0),k.setFromAxisAngle(q,g)):90==c.screenOrientation?(q=new e.Vector3(0,1,0),k.setFromAxisAngle(q,g)):-90==c.screenOrientation&&(q=new e.Vector3(0,
1,0),k.setFromAxisAngle(q,-g));C.multiply(k);C.multiply(r);n.set(m,b,-f,"YXZ");p.setFromEuler(n);p.multiply(C);p.multiply(F.setFromAxisAngle(h,-l));c.alpha=b;!0!==a&&c.dispatchEvent(d)}};this.updateAlphaOffsetAngle=function(a){this.alphaOffsetAngle=a;this.update()};this.dispose=function(){this.disconnect()};this.connect()}function ha(a){var b=new e.OrthographicCamera(-1,1,1,-1,0,1),c=new e.Scene,d=new e.StereoCamera;d.aspect=.5;var m=new e.WebGLRenderTarget(512,512,{minFilter:e.LinearFilter,magFilter:e.NearestFilter,
format:e.RGBAFormat});m.scissorTest=!0;m.texture.generateMipmaps=!1;var g=new e.Vector2(.441,.156),l=(new e.PlaneBufferGeometry(1,1,10,20)).removeAttribute("normal").toNonIndexed(),p=l.attributes.position.array,h=l.attributes.uv.array;l.attributes.position.count*=2;l.attributes.uv.count*=2;var n=new Float32Array(2*p.length);n.set(p);n.set(p,p.length);var k=new Float32Array(2*h.length);k.set(h);k.set(h,h.length);h=new e.Vector2;p=p.length/3;for(var f=0,F=n.length/3;f<F;f++){h.x=n[3*f];h.y=n[3*f+1];
var q=h.dot(h);q=1.5+(g.x+g.y*q)*q;var r=f<p?0:1;n[3*f]=h.x/q*1.5-.5+r;n[3*f+1]=h.y/q*3;k[2*f]=.5*(k[2*f]+r)}l.attributes.position.array=n;l.attributes.uv.array=k;g=new e.MeshBasicMaterial({map:m.texture});l=new e.Mesh(l,g);c.add(l);this.setSize=function(d,b){a.setSize(d,b);var c=a.getPixelRatio();m.setSize(d*c,b*c)};this.render=function(g,f){g.updateMatrixWorld();null===f.parent&&f.updateMatrixWorld();d.update(f);f=m.width/2;var e=m.height;a.autoClear&&a.clear();m.scissor.set(0,0,f,e);m.viewport.set(0,
0,f,e);a.setRenderTarget(m);a.render(g,d.cameraL);a.clearDepth();m.scissor.set(f,0,f,e);m.viewport.set(f,0,f,e);a.setRenderTarget(m);a.render(g,d.cameraR);a.clearDepth();a.setRenderTarget(null);a.render(c,b)}}function da(a){a=a||{};a.controlBar=void 0!==a.controlBar?a.controlBar:!0;a.controlButtons=a.controlButtons||["fullscreen","setting","video"];a.autoHideControlBar=void 0!==a.autoHideControlBar?a.autoHideControlBar:!1;a.autoHideInfospot=void 0!==a.autoHideInfospot?a.autoHideInfospot:!0;a.horizontalView=
...
ea={load:function(a,b,c,d){b=void 0===b?function(){}:b;c=void 0===c?function(){}:c;d=void 0===d?function(){}:d;e.Cache.enabled=!0;var m,g,l;for(f in u)u.hasOwnProperty(f)&&a===u[f]&&(l=f);var p=e.Cache.get(l?l:a);if(void 0!==p)return b&&setTimeout(function(){c({loaded:1,total:1});b(p)},0),p;var h=window.URL||window.webkitURL;var n=document.createElementNS("http://www.w3.org/1999/xhtml","img");var k=function(){h.revokeObjectURL(n.src);void 0==p&&e.Cache.add(l?l:a,n);b(n)};if(0===a.indexOf("data:"))return n.addEventListener("load",
k,!1),n.src=a,n;n.crossOrigin=void 0!==this.crossOrigin?this.crossOrigin:"";var f=new window.XMLHttpRequest;f.open("GET",a,!0);f.responseType="arraybuffer";f.addEventListener("error",d);f.addEventListener("progress",function(a){if(a){var d=a.loaded,b=a.total;a.lengthComputable&&c({loaded:d,total:b})}});f.addEventListener("loadend",function(a){a&&(m=new Uint8Array(a.currentTarget.response),g=new window.Blob([m]),n.addEventListener("load",k,!1),n.src=h.createObjectURL(g))});f.send(null)}},N={load:function(a,
b,c,d){b=void 0===b?function(){}:b;var m=new e.Texture;ea.load(a,function(d){m.image=d;d=0<a.search(/\.(jpg|jpeg)$/)||0===a.search(/^data:image\/jpeg/);m.format=d?e.RGBFormat:e.RGBAFormat;m.needsUpdate=!0;b(m)},c,d);return m}},fa={load:function(a,b,c,d){b=void 0===b?function(){}:b;c=void 0===c?function(){}:c;var m;var g=new e.CubeTexture([]);var l=0;var p={};var h={};a.map(function(a,e){ea.load(a,function(a){g.images[e]=a;l++;6===l&&(g.needsUpdate=!0,b(g))},function(a){p[e]={loaded:a.loaded,total:a.total};
h.loaded=0;m=h.total=0;for(var d in p)m++,h.loaded+=p[d].loaded,h.total+=p[d].total;6>m&&(h.total=h.total/m*6);c(h)},d)});return g}};S.prototype=Object.assign(Object.create(e.EventDispatcher.prototype),{setContainer:function(a){this.container=a},setScene:function(a){this.scene=a},enumerateDevices:function(){var a=this.devices,b=new Promise(function(b){b(a)});return 0<a.length?b:window.navigator.mediaDevices.enumerateDevices()},switchNextVideoDevice:function(){var a=this.stop.bind(this),b=this.start.bind(this),
...
updateCanvasArcByProgress:function(a){var b=this.context,c=this.canvasWidth,d=this.canvasHeight,m=this.material,g=this.dpr,e=a*Math.PI*2,p=this.color.getStyle(),h=.5*c/g;g=.5*d/g;b.clearRect(0,0,c,d);b.beginPath();0===a?(b.arc(h,g,c/16,0,2*Math.PI),b.fillStyle=p,b.fill()):(b.arc(h,g,c/4-3,-Math.PI/2,-Math.PI/2+e),b.strokeStyle=p,b.lineWidth=3,b.stroke());b.closePath();m.map.needsUpdate=!0},ripple:function(){var a=this,b=this.context,c=this.canvasWidth,d=this.canvasHeight,m=this.material,g=this.rippleDuration,
e=performance.now(),p=this.color,h=this.dpr,k=.5*c/h,q=.5*d/h,f=function(){var l=window.requestAnimationFrame(f),n=(performance.now()-e)/g,r=0<1-n?1-n:0,C=n*c*.5/h;b.clearRect(0,0,c,d);b.beginPath();b.arc(k,q,C,0,2*Math.PI);b.fillStyle="rgba("+255*p.r+", "+255*p.g+", "+255*p.b+", "+r+")";b.fill();b.closePath();1<=n&&(window.cancelAnimationFrame(l),a.updateCanvasArcByProgress(0),a.dispatchEvent({type:"reticle-ripple-end"}));m.map.needsUpdate=!0};this.dispatchEvent({type:"reticle-ripple-start"});f()},
...
1/2.75?7.5625*a*a:a<2/2.75?7.5625*(a-=1.5/2.75)*a+.75:a<2.5/2.75?7.5625*(a-=2.25/2.75)*a+.9375:7.5625*(a-=2.625/2.75)*a+.984375},InOut:function(a){return.5>a?.5*c.Easing.Bounce.In(2*a):.5*c.Easing.Bounce.Out(2*a-1)+.5}}};c.Interpolation={Linear:function(a,b){var d=a.length-1,m=d*b,e=Math.floor(m),h=c.Interpolation.Utils.Linear;return 0>b?h(a[0],a[1],m):1<b?h(a[d],a[d-1],d-m):h(a[e],a[e+1>d?d:e+1],m-e)},Bezier:function(a,b){for(var d=0,m=a.length-1,e=Math.pow,h=c.Interpolation.Utils.Bernstein,n=0;n<=
m;n++)d+=e(1-b,m-n)*e(b,n)*a[n]*h(m,n);return d},CatmullRom:function(a,b){var d=a.length-1,m=d*b,e=Math.floor(m),h=c.Interpolation.Utils.CatmullRom;return a[0]===a[d]?(0>b&&(e=Math.floor(m=d*(1+b))),h(a[(e-1+d)%d],a[e],a[(e+1)%d],a[(e+2)%d],m-e)):0>b?a[0]-(h(a[0],a[0],a[1],a[1],-m)-a[0]):1<b?a[d]-(h(a[d],a[d],a[d-1],a[d-1],m-d)-a[d]):h(a[e?e-1:0],a[e],a[d<e+1?d:e+1],a[d<e+2?d:e+2],m-e)},Utils:{Linear:function(a,b,c){return(b-a)*c+a},Bernstein:function(a,b){var d=c.Interpolation.Utils.Factorial;return d(a)/
d(b)/d(a-b)},Factorial:function(){var a=[1];return function(b){var c=1;if(a[b])return a[b];for(var d=b;1<d;d--)c*=d;return a[b]=c}}(),CatmullRom:function(a,b,c,e,p){a=.5*(c-a);e=.5*(e-b);var d=p*p;return(2*b-2*c+a+e)*p*d+(-3*b+3*c-2*a-e)*d+a*p+b}}};a.exports=c});y.prototype=Object.assign(Object.create(e.Sprite.prototype),{constructor:y,setContainer:function(a){if(a instanceof HTMLElement)var b=a;else a&&a.container&&(b=a.container);b&&this.element&&b.appendChild(this.element);this.container=b},getContainer:function(){return this.container},
...
a?a:this.paused;this.style.backgroundImage='url("'+(this.paused?u.VideoPlay:u.VideoPause)+'")'};return b},createVideoControlSeekbar:function(){function a(a){a.stopPropagation();g=!0;l=a.clientX||a.changedTouches&&a.changedTouches[0].clientX;p=parseInt(n.style.width)/100;e.container.addEventListener("mousemove",b,{passive:!0});e.container.addEventListener("mouseup",c,{passive:!0});e.container.addEventListener("touchmove",b,{passive:!0});e.container.addEventListener("touchend",c,{passive:!0})}function b(a){g&&
(h=((a.clientX||a.changedTouches&&a.changedTouches[0].clientX)-l)/f.clientWidth,h=p+h,h=1<h?1:0>h?0:h,f.setProgress(h),e.dispatchEvent({type:"panolens-viewer-handler",method:"setVideoCurrentTime",data:h}))}function c(a){a.stopPropagation();g=!1;d()}function d(){e.container.removeEventListener("mousemove",b,!1);e.container.removeEventListener("mouseup",c,!1);e.container.removeEventListener("touchmove",b,!1);e.container.removeEventListener("touchend",c,!1)}var e=this,g=!1,l,p,h;var n=document.createElement("div");
n.style.width="0%";n.style.height="100%";n.style.backgroundColor="#fff";var k=document.createElement("div");k.style.float="right";k.style.width="14px";k.style.height="14px";k.style.transform="translate(7px, -5px)";k.style.borderRadius="50%";k.style.backgroundColor="#ddd";k.addEventListener("mousedown",a,{passive:!0});k.addEventListener("touchstart",a,{passive:!0});n.appendChild(k);var f=this.createCustomItem({style:{float:"left",width:"30%",height:"4px",marginTop:"20px",backgroundColor:"rgba(188,188,188,0.8)"},
onTap:function(a){a.preventDefault();a.stopPropagation();if(a.target!==k){var b=a.changedTouches&&0<a.changedTouches.length?(a.changedTouches[0].pageX-a.target.getBoundingClientRect().left)/this.clientWidth:a.offsetX/this.clientWidth;e.dispatchEvent({type:"panolens-viewer-handler",method:"setVideoCurrentTime",data:b});f.setProgress(a.offsetX/this.clientWidth)}},onDispose:function(){d();k=n=null}});f.appendChild(n);f.setProgress=function(a){n.style.width=100*a+"%"};this.addEventListener("video-update",
function(a){f.setProgress(a.percentage)});f.progressElement=n;f.progressElementControl=k;return f},createMenuItem:function(a){var b=this,c=document.createElement("a");c.textContent=a;c.style.display="block";c.style.padding="10px";c.style.textDecoration="none";c.style.cursor="pointer";c.style.pointerEvents="auto";c.style.transition=this.DEFAULT_TRANSITION;c.slide=function(a){this.style.transform="translateX("+(a?"":"-")+"100%)"};c.unslide=function(){this.style.transform="translateX(0)"};c.setIcon=
...
var d=this,e,g=this.createMenu();g.items=b;g.activeItem=null;g.addHeader(a).addIcon(void 0,!0,!0).addEventListener(d.TOUCH_ENABLED?"touchend":"click",c,!1);for(a=0;a<b.length;a++){var l=g.addItem(b[a].title);l.style.fontWeight=300;l.handler=b[a].handler;l.addIcon(" ",!0);l.addEventListener(d.TOUCH_ENABLED?"touchend":"click",c,!1);g.activeItem||g.setActiveItem(l)}g.slideAll(!0);return g},createMenu:function(){var a=this,b=document.createElement("span"),c=b.style;c.padding="5px 0";c.position="fixed";
...
this.fadeOut(a);this.toggleInfospotVisibility(!1)}.bind(this)).start();this.dispatchEvent({type:"leave"});this.children.forEach(function(a){a.dispatchEvent({type:"panorama-leave"})});this.active=!1},dispose:function(){function a(b){for(var c=b.geometry,d=b.material,e=b.children.length-1;0<=e;e--)a(b.children[e]),b.remove(b.children[e]);b instanceof y&&b.dispose();c&&(c.dispose(),b.geometry=null);d&&(d.dispose(),b.material=null)}this.infospotAnimation.stop();this.fadeInAnimation.stop();this.fadeOutAnimation.stop();
this.enterTransition.stop();this.leaveTransition.stop();this.dispatchEvent({type:"panolens-viewer-handler",method:"onPanoramaDispose",data:this});a(this);this.parent&&this.parent.remove(this)}});x.prototype=Object.assign(Object.create(q.prototype),{constructor:x,load:function(a){a=a||this.src;if(!a)console.warn("Image source undefined");else if("string"===typeof a)N.load(a,this.onLoad.bind(this),this.onProgress.bind(this),this.onError.bind(this));else if(a instanceof HTMLImageElement)this.onLoad(new e.Texture(a))},
onLoad:function(a){a.minFilter=a.magFilter=e.LinearFilter;a.needsUpdate=!0;this.updateTexture(a);window.requestAnimationFrame(q.prototype.onLoad.bind(this))},reset:function(){q.prototype.reset.call(this)},dispose:function(){var a=this.material.map;e.Cache.remove(this.src);a&&a.dispose();q.prototype.dispose.call(this)}});W.prototype=Object.assign(Object.create(q.prototype),{constructor:W});E.prototype=Object.assign(Object.create(q.prototype),{constructor:E,load:function(){fa.load(this.images,this.onLoad.bind(this),
this.onProgress.bind(this),this.onError.bind(this))},onLoad:function(a){this.material.uniforms.tCube.value=a;q.prototype.onLoad.call(this)},dispose:function(){var a=this.material.uniforms.tCube.value;this.images.forEach(function(a){e.Cache.remove(a)});a instanceof e.CubeTexture&&a.dispose();q.prototype.dispose.call(this)}});O.prototype=Object.assign(Object.create(E.prototype),{constructor:O});A.prototype=Object.assign(Object.create(q.prototype),{constructor:A,isMobile:function(){var a=!1,b=window.navigator.userAgent||
...
dispose:function(){var a=this.material.map;this.pauseVideo();this.removeEventListener("leave",this.pauseVideo.bind(this));this.removeEventListener("enter-fade-start",this.resumeVideoProgress.bind(this));this.removeEventListener("video-toggle",this.toggleVideo.bind(this));this.removeEventListener("video-time",this.setVideoCurrentTime.bind(this));a&&a.dispose();q.prototype.dispose.call(this)}});Object.assign(P.prototype,{constructor:P,setProgress:function(a,b){if(this.onProgress)this.onProgress({loaded:a,
total:b})},adaptTextureToZoom:function(){var a=this.widths[this._zoom],b=this.heights[this._zoom],c=this.maxW,d=this.maxH;this._wc=Math.ceil(a/c);this._hc=Math.ceil(b/d);for(var e=0;e<this._hc;e++)for(var g=0;g<this._wc;g++){var l=document.createElement("canvas");l.width=g<this._wc-1?c:a-c*g;l.height=e<this._hc-1?d:b-d*e;this._canvas.push(l);this._ctx.push(l.getContext("2d"))}},composeFromTile:function(a,b,c){var d=this.maxW,e=this.maxH;a*=512;b*=512;var g=Math.floor(a/d),l=Math.floor(b/e);this._ctx[l*
this._wc+g].drawImage(c,0,0,c.width,c.height,a-g*d,b-l*e,512,512);this.progress()},progress:function(){this._count++;this.setProgress(this._count,this._total);if(this._count===this._total&&(this.canvas=this._canvas,this.panoId=this._panoId,this.zoom=this._zoom,this.onPanoramaLoad))this.onPanoramaLoad(this._canvas[0])},composePanorama:function(){this.setProgress(0,1);var a=this.levelsW[this._zoom],b=this.levelsH[this._zoom],c=this;this._count=0;this._total=a*b;for(var d=this._parameters.useWebGL,e=
0;e<b;e++)for(var g={},l=0;l<a;g={$jscomp$loop$prop$url$1:g.$jscomp$loop$prop$url$1},l++)g.$jscomp$loop$prop$url$1="https://geo0.ggpht.com/cbk?cb_client=maps_sv.tactile&authuser=0&hl=en&output=tile&zoom="+this._zoom+"&x="+l+"&y="+e+"&panoid="+this._panoId+"&nbt&fover=2",function(a){return function(b,e){if(d)var g=N.load(a.$jscomp$loop$prop$url$1,null,function(){c.composeFromTile(b,e,g)});else{var f=new Image;f.addEventListener("load",function(){c.composeFromTile(b,e,this)});f.crossOrigin="";f.src=
a.$jscomp$loop$prop$url$1}}}(g)(l,e)},load:function(a){this.loadPano(a)},loadPano:function(a){var b=this;this._panoClient.getPanoramaById(a,function(a,d){d===google.maps.StreetViewStatus.OK&&(b.result=a,b.copyright=a.copyright,b._panoId=a.location.pano,b.composePanorama())})},setZoom:function(a){this._zoom=a;this.adaptTextureToZoom()}});Z.prototype=Object.assign(Object.create(x.prototype),{constructor:Z,load:function(a){this.loadRequested=!0;(a=a||this.panoId||{},this.gsvLoader)&&this.loadGSVLoader(a)},
...
aa.prototype=Object.assign(Object.create(B.prototype),{constructor:aa,onLoad:function(a){this.updateTexture(a);B.prototype.onLoad.call(this,a)},updateTexture:function(a){a.minFilter=a.magFilter=e.LinearFilter;this.material.uniforms.tDiffuse.value=a},dispose:function(){var a=this.material.uniforms.tDiffuse;a&&a.value&&a.value.dispose();B.prototype.dispose.call(this)}});J.prototype=Object.assign(Object.create(q.prototype),{constructor:J,onPanolensContainer:function(a){this.media.setContainer(a.container)},
...
0;b<arguments.length;b++)this.add(arguments[b]);return this}this.scene.add(a);a.addEventListener&&a.addEventListener("panolens-viewer-handler",this.eventHandler.bind(this));a instanceof q&&a.dispatchEvent&&a.dispatchEvent({type:"panolens-container",container:this.container});a instanceof J&&a.dispatchEvent({type:"panolens-scene",scene:this.scene});"panorama"===a.type&&(this.addPanoramaEventListener(a),this.panorama||this.setPanorama(a))},remove:function(a){a.removeEventListener&&a.removeEventListener("panolens-viewer-handler",
...
c)};a.addEventListener("enter-fade-start",c);if(b)b.onLeave();(this.panorama=a).onEnter()}},eventHandler:function(a){if(a.method&&this[a.method])this[a.method](a.data)},dispatchEventToChildren:function(a){this.scene.traverse(function(b){b.dispatchEvent&&b.dispatchEvent(a)})},activateWidgetItem:function(a,b){var c=this.widget.mainMenu,d=c.children[0];c=c.children[1];if(void 0!==a){switch(a){case 0:a=d.subMenu.children[1];break;case 1:a=d.subMenu.children[2];break;default:a=d.subMenu.children[1]}d.subMenu.setActiveItem(a);
...
this.updateReticleEvent():(this.reticle.hide(),this.unregisterReticleEvent(),this.registerMouseAndTouchEvents())},enableAutoRate:function(){this.options.autoRotate=!0;this.OrbitControls.autoRotate=!0},disableAutoRate:function(){clearTimeout(this.autoRotateRequestId);this.options.autoRotate=!1;this.OrbitControls.autoRotate=!1},toggleVideoPlay:function(a){this.panorama instanceof A&&this.panorama.dispatchEvent({type:"video-toggle",pause:a})},setVideoCurrentTime:function(a){this.panorama instanceof A&&
...
enableControl:function(a){a=0<=a&&a<this.controls.length?a:0;this.control.enabled=!1;this.control=this.controls[a];this.control.enabled=!0;switch(a){case D.ORBIT:this.camera.position.copy(this.panorama.position);this.camera.position.z+=1;break;case D.DEVICEORIENTATION:this.camera.position.copy(this.panorama.position)}this.control.update();this.activateWidgetItem(a,void 0)},disableControl:function(){this.control.enabled=!1},toggleNextControl:function(){this.enableControl(this.getNextControlIndex())},
...
reverseDraggingDirection:function(){this.OrbitControls.rotateSpeed*=-1;this.OrbitControls.momentumScalingFactor*=-1},addReticle:function(){this.reticle=new M(16777215,!0,this.options.dwellTime);this.reticle.hide();this.camera.add(this.reticle);this.sceneReticle.add(this.camera)},tweenControlCenter:function(a,b,c){var d;if(this.control===this.OrbitControls){a instanceof Array&&(b=a[1],c=a[2],a=a[0]);b=void 0!==b?b:1E3;c=c||r.Easing.Exponential.Out;var m=this;var g=this.camera.getWorldDirection(new e.Vector3);
var l=g.clone();var k=this.panorama.getWorldPosition(new e.Vector3).sub(this.camera.getWorldPosition(new e.Vector3));a=a.clone();a.x*=-1;a.add(k).normalize();var h=a.clone();g.y=0;a.y=0;k=Math.atan2(a.z,a.x)-Math.atan2(g.z,g.x);k=k>Math.PI?k-2*Math.PI:k;k=k<-Math.PI?k+2*Math.PI:k;g=Math.abs(l.angleTo(g)+(0>=l.y*h.y?h.angleTo(a):-h.angleTo(a)));g*=h.y<l.y?1:-1;l={left:0,up:0};var n=d=0;this.tweenLeftAnimation.stop();this.tweenUpAnimation.stop();this.tweenLeftAnimation=(new r.Tween(l)).to({left:k},
b).easing(c).onUpdate(function(a){m.control.rotateLeft(a.left-d);d=a.left}).start();this.tweenUpAnimation=(new r.Tween(l)).to({up:g},b).easing(c).onUpdate(function(a){m.control.rotateUp(a.up-n);n=a.up}).start()}},tweenControlCenterByObject:function(a,b,c){var d=!1;a.traverseAncestors(function(a){a.scalePlaceHolder&&(d=!0)});if(d){var m=new e.Vector3(-1,1,1);this.tweenControlCenter(a.getWorldPosition(new e.Vector3).multiply(m),b,c)}else this.tweenControlCenter(a.getWorldPosition(new e.Vector3),b,c)},
...
this.HANDLER_KEY_DOWN,!0);window.removeEventListener("keyup",this.HANDLER_KEY_UP,!0)},dispose:function(){function a(b){for(var c=b.children.length-1;0<=c;c--)a(b.children[c]),b.remove(b.children[c]);b instanceof q||b instanceof y?b.dispose():b.dispatchEvent&&b.dispatchEvent("dispose")}this.tweenLeftAnimation.stop();this.tweenUpAnimation.stop();this.unregisterEventListeners();a(this.scene);this.widget&&(this.widget.dispose(),this.widget=null);e.Cache&&e.Cache.enabled&&e.Cache.clear()},destroy:function(){this.dispose();
this.render();window.cancelAnimationFrame(this.requestAnimationId)},onPanoramaDispose:function(a){a instanceof A&&this.hideVideoWidget();a===this.panorama&&(this.panorama=null)},loadAsyncRequest:function(a,b){b=void 0===b?function(){}:b;var c=new window.XMLHttpRequest;c.onloadend=function(a){b(a)};c.open("GET",a,!0);c.send(null)},addViewIndicator:function(){var a=this;this.loadAsyncRequest(u.ViewIndicator,function(b){if(0!==b.loaded){b=b.target.responseXML.documentElement;b.style.width=a.viewIndicatorSize+
...
this.widget.createCustomItem(a);"video"===a.group?this.widget.videoElement.appendChild(b):this.widget.barElement.appendChild(b);return b},clearAllCache:function(){e.Cache.clear()}});"105"!=e.REVISION&&console.warn("three.js version is not matched. Please consider use the target revision 105");window.TWEEN=r;k.BasicPanorama=O;k.CONTROLS=D;k.CameraPanorama=J;k.CubePanorama=E;k.CubeTextureLoader=fa;k.DataImage=u;k.EmptyPanorama=W;k.GoogleStreetviewPanorama=Z;k.ImageLittlePlanet=aa;k.ImageLoader=ea;k.ImagePanorama=
x;k.Infospot=y;k.LittlePlanet=B;k.MODES=t;k.Media=S;k.Panorama=q;k.REVISION="11";k.Reticle=M;k.THREE_REVISION="105";k.THREE_VERSION=ja;k.TextureLoader=N;k.VERSION="0.11.0";k.VideoPanorama=A;k.Viewer=da;k.Widget=I;Object.defineProperty(k,"__esModule",{value:!0})});
