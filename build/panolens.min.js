...
this.widget.createCustomItem(a);"video"===a.group?this.widget.videoElement.appendChild(b):this.widget.barElement.appendChild(b);return b},clearAllCache:function(){e.Cache.clear()}});window.TWEEN=r;h.BasicPanorama=O;h.CONTROLS=E;h.CameraPanorama=J;h.CubePanorama=F;h.CubeTextureLoader=fa;h.DataImage=u;h.EmptyPanorama=W;h.GoogleStreetviewPanorama=Z;h.ImageLittlePlanet=aa;h.ImageLoader=ea;h.ImagePanorama=y;h.Infospot=z;h.LittlePlanet=C;h.MODES=t;h.Media=S;h.Panorama=n;h.REVISION="10";h.Reticle=M;h.THREE_VERSION=
ja;h.TextureLoader=N;h.VERSION="0.10.4";h.VideoPanorama=B;h.Viewer=da;h.Widget=I;Object.defineProperty(h,"__esModule",{value:!0})});
