...
function y(a,b,c){b=b||new e.SphereBufferGeometry(5E3,60,40);c=c||new e.MeshBasicMaterial({opacity:0,transparent:!0});q.call(this,b,c);this.src=a;this.radius=5E3}function W(){var a=new e.BufferGeometry,b=new e.MeshBasicMaterial({color:0,opacity:0,transparent:!0});a.addAttribute("position",new e.BufferAttribute(new Float32Array,1));q.call(this,a,b)}function F(a){a=void 0===a?[]:a;var b=Object.assign({},e.ShaderLib.cube),c=new e.BoxBufferGeometry(1E4,1E4,1E4);b=new e.ShaderMaterial({fragmentShader:b.fragmentShader,
vertexShader:b.vertexShader,uniforms:b.uniforms,side:e.BackSide,transparent:!0});q.call(this,c,b);this.images=a;this.edgeLength=1E4;this.material.uniforms.opacity.value=0}function O(){for(var a=[],b=0;6>b;b++)a.push(u.WhiteTile);F.call(this,a)}function B(a,b){b=void 0===b?{}:b;var c=new e.SphereBufferGeometry(5E3,60,40),d=new e.MeshBasicMaterial({opacity:0,transparent:!0});q.call(this,c,d);this.src=a;this.options={videoElement:document.createElement("video"),loop:!0,muted:!0,autoplay:!1,playsinline:!0,
...
createVideoControlSeekbar:function(){function a(a){a.stopPropagation();e=!0;l=a.clientX||a.changedTouches&&a.changedTouches[0].clientX;n=parseInt(p.style.width)/100;g.container.addEventListener("mousemove",b,{passive:!0});g.container.addEventListener("mouseup",c,{passive:!0});g.container.addEventListener("touchmove",b,{passive:!0});g.container.addEventListener("touchend",c,{passive:!0})}function b(a){e&&(k=((a.clientX||a.changedTouches&&a.changedTouches[0].clientX)-l)/f.clientWidth,k=n+k,k=1<k?1:
0>k?0:k,f.setProgress(k),g.dispatchEvent({type:"panolens-viewer-handler",method:"setVideoCurrentTime",data:k}))}function c(a){a.stopPropagation();e=!1;d()}function d(){g.container.removeEventListener("mousemove",b,!1);g.container.removeEventListener("mouseup",c,!1);g.container.removeEventListener("touchmove",b,!1);g.container.removeEventListener("touchend",c,!1)}var g=this,e=!1,l,n,k;var p=document.createElement("div");p.style.width="0%";p.style.height="100%";p.style.backgroundColor="#fff";var m=
...
(h.pause(),d&&b?this.dispatchEvent({type:"panolens-viewer-handler",method:"updateVideoPlayButton",data:!1}):this.dispatchEvent({type:"panolens-viewer-handler",method:"updateVideoPlayButton",data:!0}));window.requestAnimationFrame(function(){l.map.needsUpdate=!0;n({loaded:1,total:1});k()})};2<h.readyState?e.call(this):(0===h.querySelectorAll("source").length&&(a=document.createElement("source"),a.src=this.src,h.appendChild(a)),h.load());h.addEventListener("loadeddata",e.bind(this));h.addEventListener("timeupdate",
...
this.HANDLER_KEY_DOWN,!0);window.removeEventListener("keyup",this.HANDLER_KEY_UP,!0)},dispose:function(){function a(b){for(var c=b.children.length-1;0<=c;c--)a(b.children[c]),b.remove(b.children[c]);b instanceof q||b instanceof z?b.dispose():b.dispatchEvent&&b.dispatchEvent("dispose")}this.tweenLeftAnimation.stop();this.tweenUpAnimation.stop();this.unregisterEventListeners();a(this.scene);this.widget&&(this.widget.dispose(),this.widget=null);e.Cache&&e.Cache.enabled&&e.Cache.clear()},destroy:function(){this.dispose();
