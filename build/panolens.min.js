...
h,!1),f.dispatchEvent(Y),C=A.NONE)}function n(a){if(!1!==f.enabled&&!0!==f.noZoom&&C===A.NONE){a.preventDefault();a.stopPropagation();var b=0;void 0!==a.wheelDelta?b=a.wheelDelta:void 0!==a.detail&&(b=-a.detail);0<b?(f.object.fov=f.object.fov<f.maxFov?f.object.fov+1:f.maxFov,f.object.updateProjectionMatrix()):0>b&&(f.object.fov=f.object.fov>f.minFov?f.object.fov-1:f.minFov,f.object.updateProjectionMatrix());f.update();f.dispatchEvent(U);f.dispatchEvent(S);f.dispatchEvent(Y)}}function E(a){switch(a.keyCode){case f.keys.UP:N=
!1;break;case f.keys.BOTTOM:Q=!1;break;case f.keys.LEFT:W=!1;break;case f.keys.RIGHT:X=!1}}function v(a){if(!1!==f.enabled&&!0!==f.noKeys&&!0!==f.noRotate){switch(a.keyCode){case f.keys.UP:N=!0;break;case f.keys.BOTTOM:Q=!0;break;case f.keys.LEFT:W=!0;break;case f.keys.RIGHT:X=!0}if(N||Q||W||X)R=!0,N&&(P=-f.rotateSpeed*f.momentumKeydownFactor),Q&&(P=f.rotateSpeed*f.momentumKeydownFactor),W&&(O=-f.rotateSpeed*f.momentumKeydownFactor),X&&(O=f.rotateSpeed*f.momentumKeydownFactor)}}function m(a){R=!1;
O=P=0;if(!1!==f.enabled){switch(a.touches.length){case 1:if(!0===f.noRotate)return;C=A.TOUCH_ROTATE;J.set(a.touches[0].pageX,a.touches[0].pageY);break;case 2:if(!0===f.noZoom)return;C=A.TOUCH_DOLLY;var b=a.touches[0].pageX-a.touches[1].pageX;a=a.touches[0].pageY-a.touches[1].pageY;x.set(0,Math.sqrt(b*b+a*a));break;case 3:if(!0===f.noPan)return;C=A.TOUCH_PAN;t.set(a.touches[0].pageX,a.touches[0].pageY);break;default:C=A.NONE}C!==A.NONE&&f.dispatchEvent(S)}}function g(a){if(!1!==f.enabled){a.preventDefault();
...
if(C!==A.TOUCH_DOLLY)break;b=a.touches[0].pageX-a.touches[1].pageX;a=a.touches[0].pageY-a.touches[1].pageY;y.set(0,Math.sqrt(b*b+a*a));z.subVectors(y,x);0>z.y?(f.object.fov=f.object.fov<f.maxFov?f.object.fov+1:f.maxFov,f.object.updateProjectionMatrix()):0<z.y&&(f.object.fov=f.object.fov>f.minFov?f.object.fov-1:f.minFov,f.object.updateProjectionMatrix());x.copy(y);f.update();f.dispatchEvent(U);break;case 3:if(!0===f.noPan)break;if(C!==A.TOUCH_PAN)break;r.set(a.touches[0].pageX,a.touches[0].pageY);
...
g.prototype.dispatchEventToChildren=function(a){this.scene.traverse(function(b){b.dispatchEvent&&b.dispatchEvent(a)})};g.prototype.activateWidgetItem=function(a,b){var c=this.widget.mainMenu,d=c.children[0];c=c.children[1];if(void 0!==a){switch(a){case 0:a=d.subMenu.children[1];break;case 1:a=d.subMenu.children[2];break;default:a=d.subMenu.children[1]}d.subMenu.setActiveItem(a);d.setSelectionTitle(a.textContent)}if(void 0!==b){switch(b){case q.CARDBOARD:a=c.subMenu.children[2];break;case q.STEREO:a=
c.subMenu.children[3];break;default:a=c.subMenu.children[1]}c.subMenu.setActiveItem(a);c.setSelectionTitle(a.textContent)}};g.prototype.enableEffect=function(a){if(this.mode!==a)if(a===q.NORMAL)this.disableEffect();else{this.mode=a;var b=this.camera.fov;switch(a){case q.CARDBOARD:this.effect=this.CardboardEffect;this.enableReticleControl();break;case q.STEREO:this.effect=this.StereoEffect;this.enableReticleControl();break;default:this.effect=null,this.disableReticleControl()}this.activateWidgetItem(void 0,
...
OVERLAY:"overlay"};k.Panorama=l;k.REVISION="0";k.Reticle=B;k.THREE_REVISION="136";k.THREE_VERSION=u;k.TextureLoader=Q;k.VERSION="0.0.5";k.VideoPanorama=w;k.Viewer=g;k.Widget=x;Object.defineProperty(k,"__esModule",{value:!0})});
