(function(m,e){"object"===typeof exports&&"undefined"!==typeof module?e(exports,require("three")):"function"===typeof define&&define.amd?define(["exports","three"],e):(m=m||self,e(m.PANOLENS={},m.THREE))})(this,function(m,e){function S(a){this.constraints=Object.assign({video:{width:{ideal:1920},height:{ideal:1080},facingMode:{exact:"environment"}},audio:!1},a);this.element=this.scene=this.container=null;this.devices=[];this.stream=null;this.ratioScalar=1;this.videoDeviceIndex=0}function M(a,b,c){a=
...
function y(a,b,c){b=b||new e.SphereBufferGeometry(5E3,60,40);c=c||new e.MeshBasicMaterial({opacity:0,transparent:!0});t.call(this,b,c);this.src=a;this.radius=5E3}function W(){var a=new e.BufferGeometry,b=new e.MeshBasicMaterial({color:0,opacity:0,transparent:!0});a.addAttribute("position",new e.BufferAttribute(new Float32Array,1));t.call(this,a,b)}function F(a){a=void 0===a?[]:a;var b=Object.assign({},e.ShaderLib.cube),c=new e.BoxBufferGeometry(1E4,1E4,1E4);b=new e.ShaderMaterial({fragmentShader:b.fragmentShader,
vertexShader:b.vertexShader,uniforms:b.uniforms,side:e.BackSide,transparent:!0});t.call(this,c,b);this.images=a;this.edgeLength=1E4;this.material.uniforms.opacity.value=0}function O(){for(var a=[],b=0;6>b;b++)a.push(u.WhiteTile);F.call(this,a)}function B(a,b){b=void 0===b?{}:b;var c=new e.SphereBufferGeometry(5E3,60,40),d=new e.MeshBasicMaterial({opacity:0,transparent:!0});t.call(this,c,d);this.src=a;this.options={videoElement:document.createElement("video"),loop:!0,muted:!0,autoplay:!1,playsinline:!0,
...
q.set(a.clientX,a.clientY)}x!==w.NONE&&(document.addEventListener("mousemove",d,!1),document.addEventListener("mouseup",g,!1),f.dispatchEvent(O));f.update()}}function d(a){if(!1!==f.enabled){a.preventDefault();var d=f.domElement===document?f.domElement.body:f.domElement;if(x===w.ROTATE){if(!0===f.noRotate)return;m.set(a.clientX,a.clientY);r.subVectors(m,D);f.rotateLeft(2*Math.PI*r.x/d.clientWidth*f.rotateSpeed);f.rotateUp(2*Math.PI*r.y/d.clientHeight*f.rotateSpeed);D.copy(m);G&&(K=a.clientX-G.clientX,
L=a.clientY-G.clientY);G=a}else if(x===w.DOLLY){if(!0===f.noZoom)return;z.set(a.clientX,a.clientY);T.subVectors(z,y);0<T.y?f.dollyIn():0>T.y&&f.dollyOut();y.copy(z)}else if(x===w.PAN){if(!0===f.noPan)return;U.set(a.clientX,a.clientY);t.subVectors(U,q);f.pan(t.x,t.y);q.copy(U)}x!==w.NONE&&f.update()}}function g(){Q=!0;G=void 0;!1!==f.enabled&&(document.removeEventListener("mousemove",d,!1),document.removeEventListener("mouseup",g,!1),f.dispatchEvent(P),x=w.NONE)}function h(a){if(!1!==f.enabled&&!0!==
f.noZoom&&x===w.NONE){a.preventDefault();a.stopPropagation();var d=0;void 0!==a.wheelDelta?d=a.wheelDelta:void 0!==a.detail&&(d=-a.detail);0<d?(f.object.fov=f.object.fov<f.maxFov?f.object.fov+1:f.maxFov,f.object.updateProjectionMatrix()):0>d&&(f.object.fov=f.object.fov>f.minFov?f.object.fov-1:f.minFov,f.object.updateProjectionMatrix());f.update();f.dispatchEvent(V);f.dispatchEvent(O);f.dispatchEvent(P)}}function l(a){switch(a.keyCode){case f.keys.UP:I=!1;break;case f.keys.BOTTOM:J=!1;break;case f.keys.LEFT:X=
!1;break;case f.keys.RIGHT:Y=!1}}function n(a){if(!1!==f.enabled&&!0!==f.noKeys&&!0!==f.noRotate){switch(a.keyCode){case f.keys.UP:I=!0;break;case f.keys.BOTTOM:J=!0;break;case f.keys.LEFT:X=!0;break;case f.keys.RIGHT:Y=!0}if(I||J||X||Y)Q=!0,I&&(L=-f.rotateSpeed*f.momentumKeydownFactor),J&&(L=f.rotateSpeed*f.momentumKeydownFactor),X&&(K=-f.rotateSpeed*f.momentumKeydownFactor),Y&&(K=f.rotateSpeed*f.momentumKeydownFactor)}}function k(a){Q=!1;K=L=0;if(!1!==f.enabled){switch(a.touches.length){case 1:if(!0===
f.noRotate)return;x=w.TOUCH_ROTATE;D.set(a.touches[0].pageX,a.touches[0].pageY);break;case 2:if(!0===f.noZoom)return;x=w.TOUCH_DOLLY;var d=a.touches[0].pageX-a.touches[1].pageX;a=a.touches[0].pageY-a.touches[1].pageY;y.set(0,Math.sqrt(d*d+a*a));break;case 3:if(!0===f.noPan)return;x=w.TOUCH_PAN;q.set(a.touches[0].pageX,a.touches[0].pageY);break;default:x=w.NONE}x!==w.NONE&&f.dispatchEvent(O)}}function p(a){if(!1!==f.enabled){a.preventDefault();a.stopPropagation();var d=f.domElement===document?f.domElement.body:
f.domElement;switch(a.touches.length){case 1:if(!0===f.noRotate)break;if(x!==w.TOUCH_ROTATE)break;m.set(a.touches[0].pageX,a.touches[0].pageY);r.subVectors(m,D);f.rotateLeft(2*Math.PI*r.x/d.clientWidth*f.rotateSpeed);f.rotateUp(2*Math.PI*r.y/d.clientHeight*f.rotateSpeed);D.copy(m);G&&(K=a.touches[0].pageX-G.pageX,L=a.touches[0].pageY-G.pageY);G={pageX:a.touches[0].pageX,pageY:a.touches[0].pageY};f.update();break;case 2:if(!0===f.noZoom)break;if(x!==w.TOUCH_DOLLY)break;d=a.touches[0].pageX-a.touches[1].pageX;
a=a.touches[0].pageY-a.touches[1].pageY;z.set(0,Math.sqrt(d*d+a*a));T.subVectors(z,y);0>T.y?(f.object.fov=f.object.fov<f.maxFov?f.object.fov+1:f.maxFov,f.object.updateProjectionMatrix()):0<T.y&&(f.object.fov=f.object.fov>f.minFov?f.object.fov-1:f.minFov,f.object.updateProjectionMatrix());y.copy(z);f.update();f.dispatchEvent(V);break;case 3:if(!0===f.noPan)break;if(x!==w.TOUCH_PAN)break;U.set(a.touches[0].pageX,a.touches[0].pageY);t.subVectors(U,q);f.pan(t.x,t.y);q.copy(U);f.update();break;default:x=
w.NONE}}}function v(){Q=!0;G=void 0;!1!==f.enabled&&(f.dispatchEvent(P),x=w.NONE)}this.object=a;this.domElement=void 0!==b?b:document;this.frameId=null;this.enabled=!0;this.center=this.target=new e.Vector3;this.noZoom=!1;this.zoomSpeed=1;this.minDistance=0;this.maxDistance=Infinity;this.minZoom=0;this.maxZoom=Infinity;this.noRotate=!1;this.rotateSpeed=-.15;this.noPan=!0;this.keyPanSpeed=7;this.autoRotate=!1;this.autoRotateSpeed=2;this.minPolarAngle=0;this.maxPolarAngle=Math.PI;this.momentumDampingFactor=
.9;this.momentumScalingFactor=-.005;this.momentumKeydownFactor=20;this.minFov=30;this.maxFov=120;this.minAzimuthAngle=-Infinity;this.maxAzimuthAngle=Infinity;this.noKeys=!1;this.keys={LEFT:37,UP:38,RIGHT:39,BOTTOM:40};this.mouseButtons={ORBIT:e.MOUSE.LEFT,ZOOM:e.MOUSE.MIDDLE,PAN:e.MOUSE.RIGHT};var f=this,D=new e.Vector2,m=new e.Vector2,r=new e.Vector2,q=new e.Vector2,U=new e.Vector2,t=new e.Vector2,u=new e.Vector3,A=new e.Vector3,y=new e.Vector2,z=new e.Vector2,T=new e.Vector2,R=0,H=0,B=0,C=0,E=1,
...
this.getAzimuthalAngle=function(){return R};this.dispose=function(){this.domElement.removeEventListener("mousedown",c);this.domElement.removeEventListener("mousewheel",h);this.domElement.removeEventListener("DOMMouseScroll",h);this.domElement.removeEventListener("touchstart",k);this.domElement.removeEventListener("touchend",v);this.domElement.removeEventListener("touchmove",p);window.removeEventListener("keyup",l);window.removeEventListener("keydown",n)};this.domElement.addEventListener("mousedown",
c,{passive:!1});this.domElement.addEventListener("mousewheel",h,{passive:!1});this.domElement.addEventListener("DOMMouseScroll",h,{passive:!1});this.domElement.addEventListener("touchstart",k,{passive:!1});this.domElement.addEventListener("touchend",v,{passive:!1});this.domElement.addEventListener("touchmove",p,{passive:!1});window.addEventListener("keyup",l,{passive:!1});window.addEventListener("keydown",n,{passive:!1});this.update()}function ca(a,b){var c=this,d={type:"change"},g=0,h=0,l=0,n=0;
this.camera=a;this.camera.rotation.reorder("YXZ");this.domElement=void 0!==b?b:document;this.enabled=!0;this.deviceOrientation={};this.alphaOffsetAngle=this.alpha=this.screenOrientation=0;var k=function(a){c.deviceOrientation=a},p=function(){c.screenOrientation=window.orientation||0},v=function(a){a.preventDefault();a.stopPropagation();l=a.touches[0].pageX;n=a.touches[0].pageY},f=function(a){a.preventDefault();a.stopPropagation();g+=e.Math.degToRad((a.touches[0].pageX-l)/4);h+=e.Math.degToRad((n-
a.touches[0].pageY)/4);c.updateAlphaOffsetAngle(g);l=a.touches[0].pageX;n=a.touches[0].pageY};this.connect=function(){p();window.addEventListener("orientationchange",p,{passive:!0});window.addEventListener("deviceorientation",k,{passive:!0});window.addEventListener("deviceorientation",this.update.bind(this),{passive:!0});c.domElement.addEventListener("touchstart",v,{passive:!1});c.domElement.addEventListener("touchmove",f,{passive:!1});c.enabled=!0};this.disconnect=function(){window.removeEventListener("orientationchange",
p,!1);window.removeEventListener("deviceorientation",k,!1);window.removeEventListener("deviceorientation",this.update.bind(this),!1);c.domElement.removeEventListener("touchstart",v,!1);c.domElement.removeEventListener("touchmove",f,!1);c.enabled=!1};this.update=function(a){if(!1!==c.enabled){var b=c.deviceOrientation.alpha?e.Math.degToRad(c.deviceOrientation.alpha)+c.alphaOffsetAngle:0,g=c.deviceOrientation.beta?e.Math.degToRad(c.deviceOrientation.beta):0,f=c.deviceOrientation.gamma?e.Math.degToRad(c.deviceOrientation.gamma):
0,l=c.screenOrientation?e.Math.degToRad(c.screenOrientation):0,n=c.camera.quaternion,k=new e.Vector3(0,0,1),D=new e.Euler,v=new e.Quaternion,p=new e.Quaternion(-Math.sqrt(.5),0,0,Math.sqrt(.5)),m=new e.Quaternion,r=new e.Quaternion;if(0==c.screenOrientation){var q=new e.Vector3(1,0,0);m.setFromAxisAngle(q,-h)}else 180==c.screenOrientation?(q=new e.Vector3(1,0,0),m.setFromAxisAngle(q,h)):90==c.screenOrientation?(q=new e.Vector3(0,1,0),m.setFromAxisAngle(q,h)):-90==c.screenOrientation&&(q=new e.Vector3(0,
1,0),m.setFromAxisAngle(q,-h));p.multiply(m);p.multiply(r);D.set(g,b,-f,"YXZ");n.setFromEuler(D);n.multiply(p);n.multiply(v.setFromAxisAngle(k,-l));c.alpha=b;!0!==a&&c.dispatchEvent(d)}};this.updateAlphaOffsetAngle=function(a){this.alphaOffsetAngle=a;this.update()};this.dispose=function(){this.disconnect()};this.connect()}function ha(a){var b=new e.OrthographicCamera(-1,1,1,-1,0,1),c=new e.Scene,d=new e.StereoCamera;d.aspect=.5;var g=new e.WebGLRenderTarget(512,512,{minFilter:e.LinearFilter,magFilter:e.NearestFilter,
format:e.RGBAFormat});g.scissorTest=!0;g.texture.generateMipmaps=!1;var h=new e.Vector2(.441,.156),l=(new e.PlaneBufferGeometry(1,1,10,20)).removeAttribute("normal").toNonIndexed(),n=l.attributes.position.array,k=l.attributes.uv.array;l.attributes.position.count*=2;l.attributes.uv.count*=2;var p=new Float32Array(2*n.length);p.set(n);p.set(n,n.length);var v=new Float32Array(2*k.length);v.set(k);v.set(k,k.length);k=new e.Vector2;n=n.length/3;for(var f=0,D=p.length/3;f<D;f++){k.x=p[3*f];k.y=p[3*f+1];
var m=k.dot(k);m=1.5+(h.x+h.y*m)*m;var q=f<n?0:1;p[3*f]=k.x/m*1.5-.5+q;p[3*f+1]=k.y/m*3;v[2*f]=.5*(v[2*f]+q)}l.attributes.position.array=p;l.attributes.uv.array=v;h=new e.MeshBasicMaterial({map:g.texture});l=new e.Mesh(l,h);c.add(l);this.setSize=function(d,b){a.setSize(d,b);var c=a.getPixelRatio();g.setSize(d*c,b*c)};this.render=function(h,f){h.updateMatrixWorld();null===f.parent&&f.updateMatrixWorld();d.update(f);f=g.width/2;var e=g.height;a.autoClear&&a.clear();g.scissor.set(0,0,f,e);g.viewport.set(0,
0,f,e);a.setRenderTarget(g);a.render(h,d.cameraL);a.clearDepth();g.scissor.set(f,0,f,e);g.viewport.set(f,0,f,e);a.setRenderTarget(g);a.render(h,d.cameraR);a.clearDepth();a.setRenderTarget(null);a.render(c,b)}}function da(a){e.EventDispatcher.call(this);a=a||{};a.controlBar=void 0!==a.controlBar?a.controlBar:!0;a.controlButtons=a.controlButtons||["fullscreen","setting","video"];a.autoHideControlBar=void 0!==a.autoHideControlBar?a.autoHideControlBar:!1;a.autoHideInfospot=void 0!==a.autoHideInfospot?
a.autoHideInfospot:!0;a.horizontalView=void 0!==a.horizontalView?a.horizontalView:!1;a.clickTolerance=a.clickTolerance||10;a.cameraFov=a.cameraFov||60;a.reverseDragging=a.reverseDragging||!1;a.enableReticle=a.enableReticle||!1;a.dwellTime=a.dwellTime||1500;a.autoReticleSelect=void 0!==a.autoReticleSelect?a.autoReticleSelect:!0;a.viewIndicator=void 0!==a.viewIndicator?a.viewIndicator:!1;a.indicatorSize=a.indicatorSize||30;a.output=a.output?a.output:"none";a.autoRotate=a.autoRotate||!1;a.autoRotateSpeed=
a.autoRotateSpeed||2;a.autoRotateActivationDuration=a.autoRotateActivationDuration||5E3;this.options=a;if(a.container){var b=a.container;b._width=b.clientWidth;b._height=b.clientHeight}else b=document.createElement("div"),b.classList.add("panolens-container"),b.style.width="100%",b.style.height="100%",b._width=window.innerWidth,b._height=window.innerHeight,document.body.appendChild(b);this.container=b;this.camera=a.camera||new e.PerspectiveCamera(this.options.cameraFov,this.container.clientWidth/
this.container.clientHeight,1,1E4);this.scene=a.scene||new e.Scene;this.renderer=a.renderer||new e.WebGLRenderer({alpha:!0,antialias:!1});this.sceneReticle=new e.Scene;this.viewIndicatorSize=this.options.indicatorSize;this.reticle={};this.tempEnableReticle=this.options.enableReticle;this.mode=q.NORMAL;this.pressObject=this.pressEntityObject=this.infospot=this.hoverObject=this.widget=this.panorama=null;this.raycaster=new e.Raycaster;this.raycasterPoint=new e.Vector2;this.userMouse=new e.Vector2;this.updateCallbacks=
...
this.renderer.domElement.style.display="block";this.container.style.backgroundColor="#000";this.container.appendChild(this.renderer.domElement);this.OrbitControls=new ba(this.camera,this.container);this.OrbitControls.id="orbit";this.OrbitControls.minDistance=1;this.OrbitControls.noPan=!0;this.OrbitControls.autoRotate=this.options.autoRotate;this.OrbitControls.autoRotateSpeed=this.options.autoRotateSpeed;this.DeviceOrientationControls=new ca(this.camera,this.container);this.DeviceOrientationControls.id=
...
this.registerEventListeners();this.animate.call(this)}var E={ORBIT:0,DEVICEORIENTATION:1},q={UNKNOWN:0,NORMAL:1,CARDBOARD:2,STEREO:3},u={Info:"data:image/png;base64,",
...
ea={load:function(a,b,c,d){b=void 0===b?function(){}:b;c=void 0===c?function(){}:c;d=void 0===d?function(){}:d;e.Cache.enabled=!0;var g,h,l,n;for(n in u)u.hasOwnProperty(n)&&a===u[n]&&(g=n);var k=e.Cache.get(g?g:a);if(void 0!==k)return b&&setTimeout(function(){c({loaded:1,total:1});b(k)},0),k;var p=window.URL||window.webkitURL;var v=document.createElementNS("http://www.w3.org/1999/xhtml","img");e.Cache.add(g?g:a,v);var f=function(){p.revokeObjectURL(v.src);b(v)};if(0===a.indexOf("data:"))return v.addEventListener("load",
f,!1),v.src=a,v;v.crossOrigin=void 0!==this.crossOrigin?this.crossOrigin:"";g=new window.XMLHttpRequest;g.open("GET",a,!0);g.responseType="arraybuffer";g.addEventListener("error",d);g.addEventListener("progress",function(a){if(a){var d=a.loaded,b=a.total;a.lengthComputable&&c({loaded:d,total:b})}});g.addEventListener("loadend",function(a){a&&(h=new Uint8Array(a.currentTarget.response),l=new window.Blob([h]),v.addEventListener("load",f,!1),v.src=p.createObjectURL(l))});g.send(null)}},N={load:function(a,
b,c,d){b=void 0===b?function(){}:b;var g=new e.Texture;ea.load(a,function(d){g.image=d;d=0<a.search(/\.(jpg|jpeg)$/)||0===a.search(/^data:image\/jpeg/);g.format=d?e.RGBFormat:e.RGBAFormat;g.needsUpdate=!0;b(g)},c,d);return g}},fa={load:function(a,b,c,d){b=void 0===b?function(){}:b;c=void 0===c?function(){}:c;var g;var h=new e.CubeTexture([]);var l=0;var n={};var k={};a.map(function(a,e){ea.load(a,function(a){h.images[e]=a;l++;6===l&&(h.needsUpdate=!0,b(h))},function(a){n[e]={loaded:a.loaded,total:a.total};
k.loaded=0;g=k.total=0;for(var d in n)g++,k.loaded+=n[d].loaded,k.total+=n[d].total;6>g&&(k.total=k.total/g*6);c(k)},d)});return h}};S.prototype=Object.assign(Object.create(e.EventDispatcher.prototype),{setContainer:function(a){this.container=a},setScene:function(a){this.scene=a},enumerateDevices:function(){var a=this.devices,b=new Promise(function(b){b(a)});return 0<a.length?b:window.navigator.mediaDevices.enumerateDevices()},switchNextVideoDevice:function(){var a=this.stop.bind(this),b=this.start.bind(this),
...
e=performance.now(),n=this.color,k=this.dpr,m=.5*c/k,v=.5*d/k,f=function(){var l=window.requestAnimationFrame(f),p=(performance.now()-e)/h,q=0<1-p?1-p:0,r=p*c*.5/k;b.clearRect(0,0,c,d);b.beginPath();b.arc(m,v,r,0,2*Math.PI);b.fillStyle="rgba("+255*n.r+", "+255*n.g+", "+255*n.b+", "+q+")";b.fill();b.closePath();1<=p&&(window.cancelAnimationFrame(l),a.updateCanvasArcByProgress(0),a.dispatchEvent({type:"reticle-ripple-end"}));g.map.needsUpdate=!0};this.dispatchEvent({type:"reticle-ripple-start"});f()},
...
1/2.75?7.5625*a*a:a<2/2.75?7.5625*(a-=1.5/2.75)*a+.75:a<2.5/2.75?7.5625*(a-=2.25/2.75)*a+.9375:7.5625*(a-=2.625/2.75)*a+.984375},InOut:function(a){return.5>a?.5*c.Easing.Bounce.In(2*a):.5*c.Easing.Bounce.Out(2*a-1)+.5}}};c.Interpolation={Linear:function(a,b){var d=a.length-1,g=d*b,e=Math.floor(g),k=c.Interpolation.Utils.Linear;return 0>b?k(a[0],a[1],g):1<b?k(a[d],a[d-1],d-g):k(a[e],a[e+1>d?d:e+1],g-e)},Bezier:function(a,b){for(var d=0,g=a.length-1,e=Math.pow,k=c.Interpolation.Utils.Bernstein,p=0;p<=
g;p++)d+=e(1-b,g-p)*e(b,p)*a[p]*k(g,p);return d},CatmullRom:function(a,b){var d=a.length-1,g=d*b,e=Math.floor(g),k=c.Interpolation.Utils.CatmullRom;return a[0]===a[d]?(0>b&&(e=Math.floor(g=d*(1+b))),k(a[(e-1+d)%d],a[e],a[(e+1)%d],a[(e+2)%d],g-e)):0>b?a[0]-(k(a[0],a[0],a[1],a[1],-g)-a[0]):1<b?a[d]-(k(a[d],a[d],a[d-1],a[d-1],g-d)-a[d]):k(a[e?e-1:0],a[e],a[d<e+1?d:e+1],a[d<e+2?d:e+2],g-e)},Utils:{Linear:function(a,b,c){return(b-a)*c+a},Bernstein:function(a,b){var d=c.Interpolation.Utils.Factorial;return d(a)/
...
a.right.style.display=a.style.display,a.style.display="none"):(a.style.display=a.left.style.display,a.left.style.display="none",a.right.style.display="none"),this.translateElement(b,c),this.container.appendChild(a.left),this.container.appendChild(a.right))}},translateElement:function(a,b){if(this.element._width&&this.element._height&&this.getContainer()){var c=this.container;var d=this.element;var g=d._width/2;var e=d._height/2;var l=void 0!==d.verticalDelta?d.verticalDelta:40;var n=a-g;var k=b-e-
l;this.mode!==q.CARDBOARD&&this.mode!==q.STEREO||!d.left||!d.right||a===c.clientWidth/2&&b===c.clientHeight/2?this.setElementStyle("transform",d,"translate("+n+"px, "+k+"px)"):(n=c.clientWidth/4-g+(a-c.clientWidth/2),k=c.clientHeight/2-e-l+(b-c.clientHeight/2),this.setElementStyle("transform",d.left,"translate("+n+"px, "+k+"px)"),n+=c.clientWidth/2,this.setElementStyle("transform",d.right,"translate("+n+"px, "+k+"px)"))}},setElementStyle:function(a,b,c){b=b.style;"transform"===a&&(b.webkitTransform=
b.msTransform=b.transform=c)},setText:function(a){this.element&&(this.element.textContent=a)},setCursorHoverStyle:function(a){this.cursorStyle=a},addHoverText:function(a,b){this.element||(this.element=document.createElement("div"),this.element.style.display="none",this.element.style.color="#fff",this.element.style.top=0,this.element.style.maxWidth="50%",this.element.style.maxHeight="50%",this.element.style.textShadow="0 0 3px #000000",this.element.style.fontFamily='"Trebuchet MS", Helvetica, sans-serif',
...
g.webkitRequestFullscreen&&g.webkitRequestFullscreen(Element.ALLOW_KEYBOARD_INPUT),c=!0);this.style.backgroundImage=c?'url("'+u.FullscreenLeave+'")':'url("'+u.FullscreenEnter+'")'}});if(!document.querySelector("panolens-style-addon")){var l=document.createElement("style");l.id="panolens-style-addon";l.innerHTML=":-webkit-full-screen { width: 100% !important; height: 100% !important }";document.body.appendChild(l)}return e}},createVideoControl:function(){var a=document.createElement("span");a.style.display=
...
createVideoControlSeekbar:function(){function a(a){a.stopPropagation();h=!0;l=a.clientX||a.changedTouches&&a.changedTouches[0].clientX;n=parseInt(p.style.width)/100;e.container.addEventListener("mousemove",b,{passive:!0});e.container.addEventListener("mouseup",c,{passive:!0});e.container.addEventListener("touchmove",b,{passive:!0});e.container.addEventListener("touchend",c,{passive:!0})}function b(a){h&&(k=((a.clientX||a.changedTouches&&a.changedTouches[0].clientX)-l)/f.clientWidth,k=n+k,k=1<k?1:
0>k?0:k,f.setProgress(k),e.dispatchEvent({type:"panolens-viewer-handler",method:"setVideoCurrentTime",data:k}))}function c(a){a.stopPropagation();h=!1;d()}function d(){e.container.removeEventListener("mousemove",b,!1);e.container.removeEventListener("mouseup",c,!1);e.container.removeEventListener("touchmove",b,!1);e.container.removeEventListener("touchend",c,!1)}var e=this,h=!1,l,n,k;var p=document.createElement("div");p.style.width="0%";p.style.height="100%";p.style.backgroundColor="#fff";var m=
document.createElement("div");m.style.float="right";m.style.width="14px";m.style.height="14px";m.style.transform="translate(7px, -5px)";m.style.borderRadius="50%";m.style.backgroundColor="#ddd";m.addEventListener("mousedown",a,{passive:!0});m.addEventListener("touchstart",a,{passive:!0});p.appendChild(m);var f=this.createCustomItem({style:{float:"left",width:"30%",height:"4px",marginTop:"20px",backgroundColor:"rgba(188,188,188,0.8)"},onTap:function(a){a.preventDefault();a.stopPropagation();if(a.target!==
m){var b=a.changedTouches&&0<a.changedTouches.length?(a.changedTouches[0].pageX-a.target.getBoundingClientRect().left)/this.clientWidth:a.offsetX/this.clientWidth;e.dispatchEvent({type:"panolens-viewer-handler",method:"setVideoCurrentTime",data:b});f.setProgress(a.offsetX/this.clientWidth)}},onDispose:function(){d();m=p=null}});f.appendChild(p);f.setProgress=function(a){p.style.width=100*a+"%"};this.addEventListener("video-update",function(a){f.setProgress(a.percentage)});f.progressElement=p;f.progressElementControl=
m;return f},createMenuItem:function(a){var b=this,c=document.createElement("a");c.textContent=a;c.style.display="block";c.style.padding="10px";c.style.textDecoration="none";c.style.cursor="pointer";c.style.pointerEvents="auto";c.style.transition=this.DEFAULT_TRANSITION;c.slide=function(a){this.style.transform="translateX("+(a?"":"-")+"100%)"};c.unslide=function(){this.style.transform="translateX(0)"};c.setIcon=function(a){this.icon&&(this.icon.style.backgroundImage="url("+a+")")};c.setSelectionTitle=
...
"15px";return a},createMainMenu:function(a){function b(a){a.preventDefault();a.stopPropagation();var b=c.mainMenu,d=this.subMenu;b.hide();b.slideAll();b.parentElement.appendChild(d);c.activeMainItem=this;c.activeSubMenu=d;window.requestAnimationFrame(function(){b.changeSize(d.clientWidth);d.show();d.unslideAll()})}var c=this,d=this.createMenu();d._width=200;d.changeSize(d._width);for(var e=0;e<a.length;e++){var h=d.addItem(a[e].title);h.style.paddingLeft="20px";h.addIcon().addEventListener(c.TOUCH_ENABLED?
"touchend":"click",b,!1);a[e].subMenu&&0<a[e].subMenu.length&&h.addSelection(a[e].subMenu[0].title).addSubMenu(a[e].title,a[e].subMenu)}return d},createSubMenu:function(a,b){function c(a){a.preventDefault();a.stopPropagation();e=d.mainMenu;e.changeSize(e._width);e.unslideAll();e.show();h.slideAll(!0);h.hide();"header"!==this.type&&(h.setActiveItem(this),d.activeMainItem.setSelectionTitle(this.textContent),this.handler&&this.handler())}var d=this,e,h=this.createMenu();h.items=b;h.activeItem=null;h.addHeader(a).addIcon(void 0,
!0,!0).addEventListener(d.TOUCH_ENABLED?"touchend":"click",c,!1);for(a=0;a<b.length;a++){var l=h.addItem(b[a].title);l.style.fontWeight=300;l.handler=b[a].handler;l.addIcon(" ",!0);l.addEventListener(d.TOUCH_ENABLED?"touchend":"click",c,!1);h.activeItem||h.setActiveItem(l)}h.slideAll(!0);return h},createMenu:function(){var a=this,b=document.createElement("span"),c=b.style;c.padding="5px 0";c.position="fixed";c.bottom="100%";c.right="14px";c.backgroundColor="#fafafa";c.fontFamily="Helvetica Neue";
...
(h.pause(),d&&b?this.dispatchEvent({type:"panolens-viewer-handler",method:"updateVideoPlayButton",data:!1}):this.dispatchEvent({type:"panolens-viewer-handler",method:"updateVideoPlayButton",data:!0}));window.requestAnimationFrame(function(){l.map.needsUpdate=!0;n({loaded:1,total:1});k()})};2<h.readyState?e.call(this):(h.querySelectorAll("source").length&&h.src||(h.src=this.src),h.load());h.addEventListener("loadeddata",e.bind(this));h.addEventListener("timeupdate",function(){this.videoProgress=0<=
h.duration?h.currentTime/h.duration:0;this.dispatchEvent({type:"panolens-viewer-handler",method:"onVideoUpdate",data:this.videoProgress})}.bind(this));h.addEventListener("ended",function(){c||(this.resetVideo(),this.dispatchEvent({type:"panolens-viewer-handler",method:"updateVideoPlayButton",data:!0}))}.bind(this),!1)},setVideoTexture:function(a){a&&(a=new e.VideoTexture(a),a.minFilter=e.LinearFilter,a.magFilter=e.LinearFilter,a.format=e.RGBFormat,this.updateTexture(a))},reset:function(){this.videoElement=
...
this.pauseVideo.bind(this));this.removeEventListener("enter-fade-start",this.resumeVideoProgress.bind(this));this.removeEventListener("video-toggle",this.toggleVideo.bind(this));this.removeEventListener("video-time",this.setVideoCurrentTime.bind(this));a&&a.dispose();t.prototype.dispose.call(this)}});Object.assign(P.prototype,{constructor:P,setProgress:function(a,b){if(this.onProgress)this.onProgress({loaded:a,total:b})},adaptTextureToZoom:function(){var a=this.widths[this._zoom],b=this.heights[this._zoom],
c=this.maxW,d=this.maxH;this._wc=Math.ceil(a/c);this._hc=Math.ceil(b/d);for(var e=0;e<this._hc;e++)for(var h=0;h<this._wc;h++){var l=document.createElement("canvas");l.width=h<this._wc-1?c:a-c*h;l.height=e<this._hc-1?d:b-d*e;this._canvas.push(l);this._ctx.push(l.getContext("2d"))}},composeFromTile:function(a,b,c){var d=this.maxW,e=this.maxH;a*=512;b*=512;var h=Math.floor(a/d),l=Math.floor(b/e);this._ctx[l*this._wc+h].drawImage(c,0,0,c.width,c.height,a-h*d,b-l*e,512,512);this.progress()},progress:function(){this._count++;
this.setProgress(this._count,this._total);if(this._count===this._total&&(this.canvas=this._canvas,this.panoId=this._panoId,this.zoom=this._zoom,this.onPanoramaLoad))this.onPanoramaLoad(this._canvas[0])},composePanorama:function(){this.setProgress(0,1);var a=this.levelsW[this._zoom],b=this.levelsH[this._zoom],c=this;this._count=0;this._total=a*b;for(var d=this._parameters.useWebGL,e=0;e<b;e++)for(var h={},l=0;l<a;h={$jscomp$loop$prop$url$1:h.$jscomp$loop$prop$url$1},l++)h.$jscomp$loop$prop$url$1="https://geo0.ggpht.com/cbk?cb_client=maps_sv.tactile&authuser=0&hl=en&output=tile&zoom="+
this._zoom+"&x="+l+"&y="+e+"&panoid="+this._panoId+"&nbt&fover=2",function(a){return function(b,e){if(d)var g=N.load(a.$jscomp$loop$prop$url$1,null,function(){c.composeFromTile(b,e,g)});else{var f=new Image;f.addEventListener("load",function(){c.composeFromTile(b,e,this)});f.crossOrigin="";f.src=a.$jscomp$loop$prop$url$1}}}(h)(l,e)},load:function(a){this.loadPano(a)},loadPano:function(a){var b=this;this._panoClient.getPanoramaById(a,function(a,d){d===google.maps.StreetViewStatus.OK&&(b.result=a,b.copyright=
a.copyright,b._panoId=a.location.pano,b.composePanorama())})},setZoom:function(a){this._zoom=a;this.adaptTextureToZoom()}});Z.prototype=Object.assign(Object.create(y.prototype),{constructor:Z,load:function(a){this.loadRequested=!0;(a=a||this.panoId||{},this.gsvLoader)&&this.loadGSVLoader(a)},setupGoogleMapAPI:function(a){var b=document.createElement("script");b.src="https://maps.googleapis.com/maps/api/js?";b.src+=a?"key="+a:"";b.onreadystatechange=this.setGSVLoader.bind(this);b.onload=this.setGSVLoader.bind(this);
document.querySelector("head").appendChild(b)},setGSVLoader:function(){this.gsvLoader=new P;this.loadRequested&&this.load()},getGSVLoader:function(){return this.gsvLoader},loadGSVLoader:function(a){this.loadRequested=!1;this.gsvLoader.onProgress=this.onProgress.bind(this);this.gsvLoader.onPanoramaLoad=this.onLoad.bind(this);this.gsvLoader.setZoom(this.getZoomLevel());this.gsvLoader.load(a);this.gsvLoader.loaded=!0},onLoad:function(a){y.prototype.onLoad.call(this,new e.Texture(a))},reset:function(){this.gsvLoader=
void 0;y.prototype.reset.call(this)}});var ja={uniforms:{tDiffuse:{value:new e.Texture},resolution:{value:1},transform:{value:new e.Matrix4},zoom:{value:1},opacity:{value:1}},vertexShader:"varying vec2 vUv;\nvoid main() {\nvUv = uv;\ngl_Position = vec4( position, 1.0 );\n}",fragmentShader:"uniform sampler2D tDiffuse;\nuniform float resolution;\nuniform mat4 transform;\nuniform float zoom;\nuniform float opacity;\nvarying vec2 vUv;\nconst float PI = 3.141592653589793;\nvoid main(){\nvec2 position = -1.0 +  2.0 * vUv;\nposition *= vec2( zoom * resolution, zoom * 0.5 );\nfloat x2y2 = position.x * position.x + position.y * position.y;\nvec3 sphere_pnt = vec3( 2. * position, x2y2 - 1. ) / ( x2y2 + 1. );\nsphere_pnt = vec3( transform * vec4( sphere_pnt, 1.0 ) );\nvec2 sampleUV = vec2(\n(atan(sphere_pnt.y, sphere_pnt.x) / PI + 1.0) * 0.5,\n(asin(sphere_pnt.z) / PI + 0.5)\n);\ngl_FragColor = texture2D( tDiffuse, sampleUV );\ngl_FragColor.a *= opacity;\n}"};
...
0;b<arguments.length;b++)this.add(arguments[b]);return this}this.scene.add(a);a.addEventListener&&a.addEventListener("panolens-viewer-handler",this.eventHandler.bind(this));a instanceof t&&a.dispatchEvent&&a.dispatchEvent({type:"panolens-container",container:this.container});a instanceof J&&a.dispatchEvent({type:"panolens-scene",scene:this.scene});"panorama"===a.type&&(this.addPanoramaEventListener(a),this.panorama||this.setPanorama(a))},remove:function(a){a.removeEventListener&&a.removeEventListener("panolens-viewer-handler",
...
d.setSelectionTitle(a.textContent)}if(void 0!==b){switch(b){case q.CARDBOARD:a=c.subMenu.children[2];break;case q.STEREO:a=c.subMenu.children[3];break;default:a=c.subMenu.children[1]}c.subMenu.setActiveItem(a);c.setSelectionTitle(a.textContent)}},enableEffect:function(a){if(this.mode!==a)if(a===q.NORMAL)this.disableEffect();else{this.mode=a;var b=this.camera.fov;switch(a){case q.CARDBOARD:this.effect=this.CardboardEffect;this.enableReticleControl();break;case q.STEREO:this.effect=this.StereoEffect;
this.enableReticleControl();break;default:this.effect=null,this.disableReticleControl()}this.activateWidgetItem(void 0,this.mode);this.dispatchEventToChildren({type:"panolens-dual-eye-effect",mode:this.mode});this.camera.fov=b+.01;this.effect.setSize(this.container.clientWidth,this.container.clientHeight);this.render();this.camera.fov=b;this.dispatchEvent({type:"mode-change",mode:this.mode})}},disableEffect:function(){this.mode!==q.NORMAL&&(this.mode=q.NORMAL,this.disableReticleControl(),this.activateWidgetItem(void 0,
...
reverseDraggingDirection:function(){this.OrbitControls.rotateSpeed*=-1;this.OrbitControls.momentumScalingFactor*=-1},addReticle:function(){this.reticle=new M(16777215,!0,this.options.dwellTime);this.reticle.hide();this.camera.add(this.reticle);this.sceneReticle.add(this.camera)},tweenControlCenter:function(a,b,c){var d;if(this.control===this.OrbitControls){a instanceof Array&&(b=a[1],c=a[2],a=a[0]);b=void 0!==b?b:1E3;c=c||r.Easing.Exponential.Out;var g=this;var h=this.camera.getWorldDirection(new e.Vector3);
var l=h.clone();var n=this.panorama.getWorldPosition(new e.Vector3).sub(this.camera.getWorldPosition(new e.Vector3));a=a.clone();a.x*=-1;a.add(n).normalize();var k=a.clone();h.y=0;a.y=0;n=Math.atan2(a.z,a.x)-Math.atan2(h.z,h.x);n=n>Math.PI?n-2*Math.PI:n;n=n<-Math.PI?n+2*Math.PI:n;h=Math.abs(l.angleTo(h)+(0>=l.y*k.y?k.angleTo(a):-k.angleTo(a)));h*=k.y<l.y?1:-1;l={left:0,up:0};var m=d=0;this.tweenLeftAnimation.stop();this.tweenUpAnimation.stop();this.tweenLeftAnimation=(new r.Tween(l)).to({left:n},
b).easing(c).onUpdate(function(a){g.control.rotateLeft(a.left-d);d=a.left}).start();this.tweenUpAnimation=(new r.Tween(l)).to({up:h},b).easing(c).onUpdate(function(a){g.control.rotateUp(a.up-m);m=a.up}).start()}},tweenControlCenterByObject:function(a,b,c){var d=!1;a.traverseAncestors(function(a){a.scalePlaceHolder&&(d=!0)});if(d){var g=new e.Vector3(-1,1,1);this.tweenControlCenter(a.getWorldPosition(new e.Vector3).multiply(g),b,c)}else this.tweenControlCenter(a.getWorldPosition(new e.Vector3),b,c)},
...
this.HANDLER_KEY_DOWN,!0);window.removeEventListener("keyup",this.HANDLER_KEY_UP,!0)},dispose:function(){function a(b){for(var c=b.children.length-1;0<=c;c--)a(b.children[c]),b.remove(b.children[c]);b.dispose()}this.unregisterEventListeners();a(this.scene);this.widget&&(this.widget.dispose(),this.widget=null);e.Cache&&e.Cache.enabled&&e.Cache.clear()},destroy:function(){this.dispose();this.render();window.cancelAnimationFrame(this.requestAnimationId)},onPanoramaDispose:function(a){a instanceof B&&
...
this.widget.barElement.appendChild(b);return b},clearAllCache:function(){e.Cache.clear()}});window.TWEEN=r;m.BasicPanorama=O;m.CONTROLS=E;m.CameraPanorama=J;m.CubePanorama=F;m.CubeTextureLoader=fa;m.DataImage=u;m.EmptyPanorama=W;m.GoogleStreetviewPanorama=Z;m.ImageLittlePlanet=aa;m.ImageLoader=ea;m.ImagePanorama=y;m.Infospot=z;m.LittlePlanet=C;m.MODES=q;m.Media=S;m.Panorama=t;m.REVISION="0.10.4";m.Reticle=M;m.TextureLoader=N;m.VideoPanorama=B;m.Viewer=da;m.Widget=I;Object.defineProperty(m,"__esModule",
{value:!0})});
