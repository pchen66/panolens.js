...
method:"toggleVideoPlay",data:!this.paused});this.paused=!this.paused;b.update()}});b.paused=!0;b.update=function(a){this.paused=void 0!==a?a:this.paused;this.style.backgroundImage='url("'+(this.paused?t.VideoPlay:t.VideoPause)+'")'};return b},createVideoControlSeekbar:function(){function a(a){a.stopPropagation();h=!0;q=a.clientX||a.changedTouches&&a.changedTouches[0].clientX;k=parseInt(m.style.width)/100;d.container.addEventListener("mousemove",b,{passive:!0});d.container.addEventListener("mouseup",
c,{passive:!0});d.container.addEventListener("touchmove",b,{passive:!0});d.container.addEventListener("touchend",c,{passive:!0})}function b(a){h&&(l=((a.clientX||a.changedTouches&&a.changedTouches[0].clientX)-q)/f.clientWidth,l=k+l,l=1<l?1:0>l?0:l,f.setProgress(l),d.dispatchEvent({type:"panolens-viewer-handler",method:"setVideoCurrentTime",data:l}))}function c(a){a.stopPropagation();h=!1;e()}function e(){d.container.removeEventListener("mousemove",b,!1);d.container.removeEventListener("mouseup",c,
!1);d.container.removeEventListener("touchmove",b,!1);d.container.removeEventListener("touchend",c,!1)}var d=this,h=!1,q,k,l;var m=document.createElement("div");m.style.width="0%";m.style.height="100%";m.style.backgroundColor="#fff";var n=document.createElement("div");n.style.float="right";n.style.width="14px";n.style.height="14px";n.style.transform="translate(7px, -5px)";n.style.borderRadius="50%";n.style.backgroundColor="#ddd";n.addEventListener("mousedown",a,{passive:!0});n.addEventListener("touchstart",
a,{passive:!0});m.appendChild(n);var f=this.createCustomItem({style:{float:"left",width:"30%",height:"4px",marginTop:"20px",backgroundColor:"rgba(188,188,188,0.8)"},onTap:function(a){a.preventDefault();a.stopPropagation();if(a.target!==n){var b=a.changedTouches&&0<a.changedTouches.length?(a.changedTouches[0].pageX-a.target.getBoundingClientRect().left)/this.clientWidth:a.offsetX/this.clientWidth;d.dispatchEvent({type:"panolens-viewer-handler",method:"setVideoCurrentTime",data:b});f.setProgress(a.offsetX/
...
var ja=function(a){var b=new d.StereoCamera;b.aspect=.5;var c=new d.Vector2;this.setEyeSeparation=function(a){b.eyeSep=a};this.setSize=function(b,c){a.setSize(b,c)};this.render=function(d,g,h){var e=h instanceof M||h instanceof T;d.updateMatrixWorld();null===g.parent&&g.updateMatrixWorld();e&&this.setEyeSeparation(h.stereo.eyeSep);b.update(g);a.getSize(c);a.autoClear&&a.clear();a.setScissorTest(!0);e&&h.updateTextureToLeft();a.setScissor(0,0,c.width/2,c.height);a.setViewport(0,0,c.width/2,c.height);
a.render(d,b.cameraL);e&&h.updateTextureToRight();a.setScissor(c.width/2,0,c.width/2,c.height);a.setViewport(c.width/2,0,c.width/2,c.height);a.render(d,b.cameraR);a.setScissorTest(!1);e&&h.updateTextureToLeft()}};ea.prototype=Object.assign(Object.create(d.EventDispatcher.prototype),{constructor:ea,add:function(a){if(1<arguments.length){for(var b=0;b<arguments.length;b++)this.add(arguments[b]);return this}this.scene.add(a);a.addEventListener&&a.addEventListener("panolens-viewer-handler",this.eventHandler.bind(this));
...
b.dispatchEvent(a)})},activateWidgetItem:function(a,b){var c=this.widget.mainMenu,d=c.children[0];c=c.children[1];if(void 0!==a){switch(a){case 0:a=d.subMenu.children[1];break;case 1:a=d.subMenu.children[2];break;default:a=d.subMenu.children[1]}d.subMenu.setActiveItem(a);d.setSelectionTitle(a.textContent)}if(void 0!==b){switch(b){case r.CARDBOARD:a=c.subMenu.children[2];break;case r.STEREO:a=c.subMenu.children[3];break;default:a=c.subMenu.children[1]}c.subMenu.setActiveItem(a);c.setSelectionTitle(a.textContent)}},
...
(0>=c.y*g.y?g.angleTo(a):-g.angleTo(a)));b*=g.y<c.y?1:-1;return{left:e,up:b}}},setControlCenter:function(a){this.control===this.OrbitControls&&(a=this.calculateOrbitControlDelta(a),this.rotateOrbitControl(a.left,a.up))},tweenControlCenter:function(a,b,c){if(this.control===this.OrbitControls){a instanceof Array&&(a=a[0],b=a[1],c=a[2]);b=void 0!==b?b:1E3;c=c||n.Easing.Exponential.Out;var d=this.calculateOrbitControlDelta(a);a=d.left;d=d.up;var g=this.rotateOrbitControlLeft.bind(this),h=this.rotateOrbitControlUp.bind(this),
k={left:0,up:0},m=0,l=0;this.tweenLeftAnimation.stop();this.tweenUpAnimation.stop();this.tweenLeftAnimation=(new n.Tween(k)).to({left:a},b).easing(c).onUpdate(function(a){g(a.left-m);m=a.left}).start();this.tweenUpAnimation=(new n.Tween(k)).to({up:d},b).easing(c).onUpdate(function(a){h(a.up-l);l=a.up}).start()}},tweenControlCenterByObject:function(a,b,c){this.tweenControlCenter(a.getWorldPosition(new d.Vector3),b,c)},onWindowResize:function(a,b){var c=this.container.classList.contains("panolens-container")||
