...
this.onPanolensScene.bind(this))}function M(a,b){b=void 0===b?new F:b;u.call(this,a);this.stereo=b;this.type="stereo_image_panorama"}function T(a,b,c){b=void 0===b?{}:b;c=void 0===c?new F:c;z.call(this,a,b);this.stereo=c;this.type="stereo_video_panorama"}function ca(a,b){function c(a){U=!1;N=O=0;if(!1!==f.enabled){a.preventDefault();if(a.button===f.mouseButtons.ORBIT){if(!0===f.noRotate)return;w=v.ROTATE;B.set(a.clientX,a.clientY)}else if(a.button===f.mouseButtons.ZOOM){if(!0===f.noZoom)return;w=
v.DOLLY;u.set(a.clientX,a.clientY)}else if(a.button===f.mouseButtons.PAN){if(!0===f.noPan)return;w=v.PAN;m.set(a.clientX,a.clientY)}w!==v.NONE&&(document.addEventListener("mousemove",e,!1),document.addEventListener("mouseup",g,!1),f.dispatchEvent(R));f.update()}}function e(a){if(!1!==f.enabled){a.preventDefault();var b=f.domElement===document?f.domElement.body:f.domElement;if(w===v.ROTATE){if(!0===f.noRotate)return;k.set(a.clientX,a.clientY);n.subVectors(k,B);f.rotateLeft(2*Math.PI*n.x/b.clientWidth*
f.rotateSpeed);f.rotateUp(2*Math.PI*n.y/b.clientHeight*f.rotateSpeed);B.copy(k);G&&(N=a.clientX-G.clientX,O=a.clientY-G.clientY);G=a}else if(w===v.DOLLY){if(!0===f.noZoom)return;y.set(a.clientX,a.clientY);z.subVectors(y,u);0<z.y?f.dollyIn():0>z.y&&f.dollyOut();u.copy(y)}else if(w===v.PAN){if(!0===f.noPan)return;W.set(a.clientX,a.clientY);t.subVectors(W,m);f.pan(t.x,t.y);m.copy(W)}w!==v.NONE&&f.update()}}function g(){U=!0;G=void 0;!1!==f.enabled&&(document.removeEventListener("mousemove",e,!1),document.removeEventListener("mouseup",
...
N=O=0;if(!1!==f.enabled){switch(a.touches.length){case 1:if(!0===f.noRotate)return;w=v.TOUCH_ROTATE;B.set(a.touches[0].pageX,a.touches[0].pageY);break;case 2:if(!0===f.noZoom)return;w=v.TOUCH_DOLLY;var b=a.touches[0].pageX-a.touches[1].pageX;a=a.touches[0].pageY-a.touches[1].pageY;u.set(0,Math.sqrt(b*b+a*a));break;case 3:if(!0===f.noPan)return;w=v.TOUCH_PAN;m.set(a.touches[0].pageX,a.touches[0].pageY);break;default:w=v.NONE}w!==v.NONE&&f.dispatchEvent(R)}}function x(a){if(!1!==f.enabled){a.preventDefault();
a.stopPropagation();var b=f.domElement===document?f.domElement.body:f.domElement;switch(a.touches.length){case 1:if(!0===f.noRotate)break;if(w!==v.TOUCH_ROTATE)break;k.set(a.touches[0].pageX,a.touches[0].pageY);n.subVectors(k,B);f.rotateLeft(2*Math.PI*n.x/b.clientWidth*f.rotateSpeed);f.rotateUp(2*Math.PI*n.y/b.clientHeight*f.rotateSpeed);B.copy(k);G&&(N=a.touches[0].pageX-G.pageX,O=a.touches[0].pageY-G.pageY);G={pageX:a.touches[0].pageX,pageY:a.touches[0].pageY};f.update();break;case 2:if(!0===f.noZoom)break;
...
t.subVectors(W,m);f.pan(t.x,t.y);m.copy(W);f.update();break;default:w=v.NONE}}}function P(){U=!0;G=void 0;!1!==f.enabled&&(f.dispatchEvent(S),w=v.NONE)}this.object=a;this.domElement=void 0!==b?b:document;this.frameId=null;this.enabled=!0;this.center=this.target=new d.Vector3;this.noZoom=!1;this.zoomSpeed=1;this.minDistance=0;this.maxDistance=Infinity;this.minZoom=0;this.maxZoom=Infinity;this.noRotate=!1;this.rotateSpeed=-.15;this.noPan=!0;this.keyPanSpeed=7;this.autoRotate=!1;this.autoRotateSpeed=
2;this.minPolarAngle=0;this.maxPolarAngle=Math.PI;this.momentumDampingFactor=.9;this.momentumScalingFactor=-.005;this.momentumKeydownFactor=20;this.minFov=30;this.maxFov=120;this.minAzimuthAngle=-Infinity;this.maxAzimuthAngle=Infinity;this.noKeys=!1;this.keys={LEFT:37,UP:38,RIGHT:39,BOTTOM:40};this.mouseButtons={ORBIT:d.MOUSE.LEFT,ZOOM:d.MOUSE.MIDDLE,PAN:d.MOUSE.RIGHT};var f=this,B=new d.Vector2,k=new d.Vector2,n=new d.Vector2,m=new d.Vector2,W=new d.Vector2,t=new d.Vector2,r=new d.Vector3,A=new d.Vector3,
u=new d.Vector2,y=new d.Vector2,z=new d.Vector2,V=0,H=0,C=0,D=0,E=1,F=new d.Vector3,K=new d.Vector3,Q=new d.Quaternion,N=0,O=0,G,U=!1,I,J,L,M,v={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_DOLLY:4,TOUCH_PAN:5},w=v.NONE;this.target0=this.target.clone();this.position0=this.object.position.clone();this.zoom0=this.object.zoom;var T=(new d.Quaternion).setFromUnitVectors(a.up,new d.Vector3(0,1,0)),Y=T.clone().inverse(),X={type:"change"},R={type:"start"},S={type:"end"};this.setLastQuaternion=function(a){Q.copy(a);
f.object.quaternion.copy(a)};this.getLastPosition=function(){return K};this.rotateLeft=function(a){void 0===a&&(a=2*Math.PI/60/60*f.autoRotateSpeed);D-=a};this.rotateUp=function(a){void 0===a&&(a=2*Math.PI/60/60*f.autoRotateSpeed);C-=a};this.panLeft=function(a){var b=this.object.matrix.elements;r.set(b[0],b[1],b[2]);r.multiplyScalar(-a);F.add(r)};this.panUp=function(a){var b=this.object.matrix.elements;r.set(b[4],b[5],b[6]);r.multiplyScalar(a);F.add(r)};this.pan=function(a,b){var e=f.domElement===
...
A.z);H=Math.atan2(Math.sqrt(A.x*A.x+A.z*A.z),A.y);this.autoRotate&&w===v.NONE&&this.rotateLeft(2*Math.PI/60/60*f.autoRotateSpeed);this.momentum();V+=D;H+=C;V=Math.max(this.minAzimuthAngle,Math.min(this.maxAzimuthAngle,V));H=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,H));H=Math.max(1E-7,Math.min(Math.PI-1E-7,H));var e=A.length()*E;e=Math.max(this.minDistance,Math.min(this.maxDistance,e));this.target.add(F);A.x=e*Math.sin(H)*Math.sin(V);A.y=e*Math.cos(H);A.z=e*Math.sin(H)*Math.cos(V);A.applyQuaternion(Y);
b.copy(this.target).add(A);this.object.lookAt(this.target);C=D=0;E=1;F.set(0,0,0);if(1E-7<K.distanceToSquared(this.object.position)||1E-7<8*(1-Q.dot(this.object.quaternion)))!0!==a&&this.dispatchEvent(X),K.copy(this.object.position),Q.copy(this.object.quaternion)};this.reset=function(){w=v.NONE;this.target.copy(this.target0);this.object.position.copy(this.position0);this.object.zoom=this.zoom0;this.object.updateProjectionMatrix();this.dispatchEvent(X);this.update()};this.getPolarAngle=function(){return H};
this.getAzimuthalAngle=function(){return V};this.dispose=function(){this.domElement.removeEventListener("mousedown",c);this.domElement.removeEventListener("mousewheel",h);this.domElement.removeEventListener("DOMMouseScroll",h);this.domElement.removeEventListener("touchstart",l);this.domElement.removeEventListener("touchend",P);this.domElement.removeEventListener("touchmove",x);window.removeEventListener("keyup",q);window.removeEventListener("keydown",p)};this.domElement.addEventListener("mousedown",
...
0,f,d);a.setRenderTarget(g);a.render(h,e.cameraL);a.clearDepth();g.scissor.set(f,0,f,d);g.viewport.set(f,0,f,d);a.setRenderTarget(g);a.render(h,e.cameraR);a.clearDepth();a.setRenderTarget(null);a.render(c,b)}}function ea(a){a=void 0===a?{}:a;var b=this.options=Object.assign({container:this.setupContainer(a.container),controlBar:!0,controlButtons:["fullscreen","setting","video"],autoHideControlBar:!1,autoHideInfospot:!0,horizontalView:!1,clickTolerance:10,cameraFov:60,reverseDragging:!1,enableReticle:!1,
dwellTime:1500,autoReticleSelect:!0,viewIndicator:!1,indicatorSize:30,output:null,autoRotate:!1,autoRotateSpeed:2,autoRotateActivationDuration:5E3},a);a=b.container;var c=b.cameraFov,e=b.controlBar,g=b.controlButtons,h=b.viewIndicator,q=b.indicatorSize,p=b.enableReticle,l=b.reverseDragging,k=b.output,m=b.scene,f=b.camera;b=b.renderer;var B=a.clientWidth,r=a.clientHeight;this.container=a;this.scene=this.setupScene(m);this.sceneReticle=new d.Scene;this.camera=this.setupCamera(c,B/r,f);this.renderer=
...
new d.Matrix4;this.outputDivElement=this.autoRotateRequestId=null;this.touchSupported="ontouchstart"in window||window.DocumentTouch&&document instanceof DocumentTouch;this.tweenLeftAnimation=new n.Tween;this.tweenUpAnimation=new n.Tween;this.outputEnabled=!1;this.viewIndicatorSize=q;this.tempEnableReticle=p;this.handlerMouseUp=this.onMouseUp.bind(this);this.handlerMouseDown=this.onMouseDown.bind(this);this.handlerMouseMove=this.onMouseMove.bind(this);this.handlerWindowResize=this.onWindowResize.bind(this);
this.handlerKeyDown=this.onKeyDown.bind(this);this.handlerKeyUp=this.onKeyUp.bind(this);this.handlerTap=this.onTap.bind(this,{clientX:B/2,clientY:r/2});e&&this.addDefaultControlBar(g);h&&this.addViewIndicator();l&&this.reverseDraggingDirection();p?this.enableReticleControl():this.registerMouseAndTouchEvents();"overlay"===k&&this.addOutputElement();this.registerEventListeners();this.animate.call(this)}var ja="^0.105.2".replace(/[^0-9.]/g,""),E={ORBIT:0,DEVICEORIENTATION:1},t={UNKNOWN:0,NORMAL:1,CARDBOARD:2,
STEREO:3},D={TAB:0,SBS:1},r={Info:"data:image/png;base64,",
...
fa={load:function(a,b,c,e){b=void 0===b?function(){}:b;c=void 0===c?function(){}:c;e=void 0===e?function(){}:e;d.Cache.enabled=!0;var g,h,q,p;for(p in r)r.hasOwnProperty(p)&&a===r[p]&&(g=p);var l=d.Cache.get(g?g:a);if(void 0!==l)return b&&setTimeout(function(){c({loaded:1,total:1});b(l)},0),l;var k=window.URL||window.webkitURL;var m=document.createElementNS("http://www.w3.org/1999/xhtml","img");d.Cache.add(g?g:a,m);var f=function(){k.revokeObjectURL(m.src);b(m)};if(0===a.indexOf("data:"))return m.addEventListener("load",
...
{constructor:F,updateUniformByFormat:function(a,b){this.format=a;var c=b.repeat.value;b=b.offset.value;var e=this.loffset,g=this.roffset;switch(a){case D.TAB:c.set(1,.5);b.set(0,.5);e.set(0,.5);g.set(0,0);break;case D.SBS:c.set(.5,1),b.set(0,0),e.set(0,0),g.set(.5,0)}},updateTextureToLeft:function(a){a.copy(this.loffset)},updateTextureToRight:function(a){a.copy(this.roffset)}});Q.prototype=Object.assign(Object.create(d.Sprite.prototype),{constructor:Q,setColor:function(a){this.material.color.copy(a instanceof
...
c),this.container.appendChild(a.left),this.container.appendChild(a.right))}},translateElement:function(a,b){if(this.element._width&&this.element._height&&this.getContainer()){var c=this.container;var e=this.element;var g=e._width/2;var d=e._height/2;var q=void 0!==e.verticalDelta?e.verticalDelta:40;var p=a-g;var l=b-d-q;this.mode!==t.CARDBOARD&&this.mode!==t.STEREO||!e.left||!e.right||a===c.clientWidth/2&&b===c.clientHeight/2?this.setElementStyle("transform",e,"translate("+p+"px, "+l+"px)"):(p=c.clientWidth/
...
{constructor:ca});da.prototype=Object.assign(Object.create(d.EventDispatcher.prototype),{constructor:da});var ma=function(a){var b=new d.StereoCamera;b.aspect=.5;var c=new d.Vector2;this.setEyeSeparation=function(a){b.eyeSep=a};this.setSize=function(b,c){a.setSize(b,c)};this.render=function(e,d,h){var g=h instanceof M||h instanceof T;e.updateMatrixWorld();null===d.parent&&d.updateMatrixWorld();g&&this.setEyeSeparation(h.stereo.eyeSep);b.update(d);a.getSize(c);a.autoClear&&a.clear();a.setScissorTest(!0);
...
a instanceof L&&a.dispatchEvent({type:"panolens-scene",scene:this.scene});a instanceof m&&(this.addPanoramaEventListener(a),this.panorama||this.setPanorama(a))},remove:function(a){a.removeEventListener&&a.removeEventListener("panolens-viewer-handler",this.eventHandler.bind(this));this.scene.remove(a)},addDefaultControlBar:function(a){if(this.widget)console.warn("Default control bar exists");else{var b=new J(this.container);b.addEventListener("panolens-viewer-handler",this.eventHandler.bind(this));
...
"video"===a.group?this.widget.videoElement.appendChild(b):this.widget.barElement.appendChild(b);return b},clearAllCache:function(){d.Cache.clear()}});"105"!=d.REVISION&&console.warn("three.js version is not matched. Please consider use the target revision 105");window.TWEEN=n;k.BasicPanorama=S;k.CONTROLS=E;k.CameraPanorama=L;k.CubePanorama=K;k.CubeTextureLoader=ha;k.DataImage=r;k.EmptyPanorama=R;k.GoogleStreetviewPanorama=aa;k.ImageLittlePlanet=ba;k.ImageLoader=fa;k.ImagePanorama=u;k.Infospot=y;k.LittlePlanet=
C;k.MODES=t;k.Media=Y;k.Panorama=m;k.REVISION="11";k.Reticle=Q;k.STEREOFORMAT=D;k.Stereo=F;k.StereoImagePanorama=M;k.StereoVideoPanorama=T;k.THREE_REVISION="105";k.THREE_VERSION=ja;k.TextureLoader=I;k.VERSION="0.11.0";k.VideoPanorama=z;k.Viewer=ea;k.Widget=J;Object.defineProperty(k,"__esModule",{value:!0})});
