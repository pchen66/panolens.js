...
this.widget.createCustomItem(a);"video"===a.group?this.widget.videoElement.appendChild(b):this.widget.barElement.appendChild(b);return b},clearAllCache:function(){e.Cache.clear()}});"113"!=e.REVISION&&console.warn("three.js version is not matched. Please consider use the target revision 113");window.TWEEN=r;h.BasicPanorama=O;h.CONTROLS=E;h.CameraPanorama=J;h.CubePanorama=F;h.CubeTextureLoader=fa;h.DataImage=u;h.EmptyPanorama=W;h.GoogleStreetviewPanorama=Z;h.ImageLittlePlanet=aa;h.ImageLoader=ea;h.ImagePanorama=
y;h.Infospot=z;h.LittlePlanet=C;h.MODES=t;h.Media=S;h.Panorama=n;h.REVISION="11";h.Reticle=M;h.THREE_REVISION="113";h.THREE_VERSION=ja;h.TextureLoader=N;h.VERSION="0.11.0";h.VideoPanorama=B;h.Viewer=da;h.Widget=I;Object.defineProperty(h,"__esModule",{value:!0})});
